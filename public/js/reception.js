$(document).ready(function () {
    ...
    $("#search_input_name").change(function(){
        ...
        if($("#search_input_name").val().length>1){
            ...
            if(keys.length>0){
                ...
                var show_name=$("<tr>").append($("<td>").text(serch_name_result[value]["Pid"]))
                                .append($("<td>").text(serch_name_result[value]["FuchiaID"]))
                                .append($("<td>").text(serch_name_result[value]["Name"]))
                                .append($("<td>").text(serch_name_result[value]["Father"]))
                                .append($("<td>").text(serch_name_result[value]["Agey"]))
                                .append($("<td>").text(serch_name_result[value]["Reg Date"]));
    ...
    $("#resDiaSecton ul li input[type='checkbox']").click(function(){
       var diease_checkId=event.target.id;
       var checkParentId=$("#"+diease_checkId).parent().parent().attr('id');
