          ...
          <div class="col-md-12 "  >
              ...
              <div class="row">
                ...
                <div class="col-md-2 consulor-prepost">
                  <input type="checkbox" id="pre" style=" height: 20px;"  > <span style='color: blue;'>Pre-test Counselling</span>     <br>
                  <input type="checkbox" id="post"  style=" height: 20px;" > <span style='color: red;'>Post-test Counselling</span>
                </div>
                <div class="col-sm-2 consulor-mainrisk">
              ...
              <div class='row' >
                <div class="col-sm-1" >
                  <button type="button" id="updateBton" onclick="update()" class="btn btn-warning save-batton ">Save</button>
                </div>
              </div>
              <br>
              <div class="row">
