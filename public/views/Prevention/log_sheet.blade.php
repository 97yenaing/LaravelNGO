    ...
    <div class="tab-content">
      ...
      <div class="tab-pane container containers  active" id="confid">
        ...
        <div class="row recepatient-info">
          <div class="col-md-2 reception-visitDate">
            ...
            <div class="date-holder">
              <input type="text" id="register_date" class="form-control Gdate date-verify " onchange="reg_date_change()"
        ...
        <div class="row">
          <div class="col-sm-2 reception-re-fo">
            <button type="button" style="display:none;" id="regbutton" onclick="confidentialSave(1)"
              class="btn btn-primary reception-register">Register</button>
            <button type="button" style="display:none;" id="updatebutton" onclick="confidentialSave(2)"
      ...
      <div class="tab-pane container containers fade" id="log_sheet">
        <div class="log-sheetSection">
          ...
          <div class="row">
            <div class="col-md-2">
              <input id="log_sheet_ID_change" type="checkbox" onchange="show_update_ID_box()">If need
              to change General
              ID
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-1">
              <button type="button" onclick="serarch_change()" id="log_serach_chagne"
          ...
          <div class="log-first">
            <div class="row">
              ...
              <div class="col-md-2">
                <div class="date-holder">
                  <input type="text" id="vDate" required class="form-control Gdate date-verify"
                    onblur="define_new_old()" placeholder="dd-mm-yyyy">
                  <img src="../img/calendar3.svg" class="dateimg" alt="date">
                </div>
              </div>
              <div class="col-md-2">
          ...
          <div class="log-second">
            <div class="row">
              ...
              <div class="col-md-2">
                <div class="date-holder">
                  <input type="text" id="hiv_comfirm_date" class="form-control Gdate date-verify "
                    placeholder="dd-mm-yyyy">
                  <img src="../img/calendar3.svg" class="dateimg" alt="date">
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                <input type="text" id="referral_cupon" class="form-control">
              </div>
              <div class="col-md-2">
        ...
        <div class="cbs-Section" id="cbs-section" style="display:none;">
          <div class="row">
            ...
            <div class="dropdown col-md-2">
              <button class="btn btn-secondary dropdown-toggle cbs-serviceTK" type="button" id="dropdownMenuButton"
                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Service Provision
              </button>
              <div class="dropdown-menu" id="cbs_Check" aria-labelledby="dropdownMenuButton">
                ...
                <label class="dropdown-item">
                  <input type="checkbox" id="service_pro_cbs" onchange="cbs_check()" value="CBS counselling"> CBS
                  Counselling
                </label>
              </div>
            </div>
            ...
            <div class="col-md-4">
              ...
              <div class="date-holder">
                <input type="text" id="date_arrival_confirm_facility" class="form-control Gdate date-verify "
                  placeholder="dd-mm-yyyy">
                <img src="../img/calendar3.svg" class="dateimg" alt="date">
              </div>
            </div>
        ...
        <form action="{{ route('prevention_data') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-md-2">
              ...
              <div class="date-holder">
                <input type="text" id="ddTo" name="ddTo" class="form-control Gdate date-verify  "
                  placeholder="dd-mm-yyyy">
                <img src="../img/calendar3.svg" class="dateimg" alt="date">
              </div>
            </div>
