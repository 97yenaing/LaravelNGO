    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{$ncd_record["Area_Division"]}}</td>
          <td>{{$ncd_record["Township"]}}</td>
          <td>{{$ncd_record["NCD_Diagnosis"]}}</td>
          <td>{{$ncd_record["Follow_Height"]}}</td>
          <td>{{$ncd_record["Follow_Weight"]}}</td>
          <td>{{$ncd_record["Follow_Bmi"]}}</td>
          <td>{{$ncd_record["Type_cur_visit"]}}</td>
          <td>{{$ncd_record["Late_visit"]}}</td>
          <td>{{$ncd_record["Late_duration"]}}</td>
          <td>{{$ncd_record["Late_follow"]}}</td>
          @foreach ($columnses as $item)
          <td>{{$ncd_record[$item]}}</td>
          @endforeach
