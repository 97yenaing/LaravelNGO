...
<body>
  <form action="">
    <table>
      ...
      <tbody>
        @foreach ($sti_records as $sti_record)
        <tr>
          <td style="width:100px;">{{ $sti_record["Clinic Code"] }}</td>
          <td style="width:100px;">{{ $sti_record["CID"] }}</td>
          <td style="width:100px;">{{ $sti_record["FuchiaID"] }}</td>
          <td style="width:100px;">{{ $sti_record["Gender"] }}</td>
          <td style="width:80px;">{{ $sti_record['Reg year'] }}</td>
          <td style="width:80px;">{{ $sti_record['Register Agey'] }}</td>
          <td style="width:80px;">{{ $sti_record['Register Agem'] }}</td>
          <td style="width:80px;">{{ $sti_record['Current Agey'] }}</td>
          <td style="width:80px;">{{ $sti_record['Current Agem'] }}</td>
          <td style="width:100px;">{{ $sti_record["Visit_date"] }}</td>

          <td style="width:100px;">{{ $sti_record["last_vis_within"] }}</td>
          <td style="width:100px;">{{ $sti_record["about_clinic"] }}</td>
          <td style="width:100px;">{{ $sti_record["demo_remarks"] }}</td>
          <td style="width:100px;">{{ $sti_record["visit_type"] }}</td>
          <td style="width:100px;">{{ $sti_record["visit_time"] }}</td>
          <td style="width:100px;">{{ $sti_record["followup_visit"] }}</td>
          <td style="width:100px;">{{ $sti_record["episode"] }}</td>
          <td style="width:100px;">{{ $sti_record["Reason for Visit"] }}</td>
          <td style="width:100px;">{{ $sti_record["Main Risk"] }}</td>
          <td style="width:100px;">{{ $sti_record["urethral_disc"] }}</td>
          <td style="width:100px;">{{ $sti_record["urethral_disc_hl"] }}</td>
          <td style="width:100px;">{{ $sti_record["dysuria"] }}</td>
          <td style="width:100px;">{{ $sti_record["dysuria_hl"] }}</td>
          <td style="width:100px;">{{ $sti_record["genital_prut"] }}</td>
          <td style="width:100px;">{{ $sti_record["genital_prut_hl"] }}</td>
          <td style="width:100px;">{{ $sti_record["genital_pain"] }}</td>
          <td style="width:100px;">{{ $sti_record["genital_pain_hl"] }}</td>
          <td style="width:100px;">{{ $sti_record["genital_ulcer"] }}</td>
          <td style="width:100px;">{{ $sti_record["genital_ulcer_hl"] }}</td>
          <td style="width:100px;">{{ $sti_record["pain"] }}</td>
          <td style="width:100px;">{{ $sti_record["ulcer"] }}</td>
          <td style="width:100px;">{{ $sti_record["prodromal_itch"] }}</td>
          <td style="width:100px;">{{ $sti_record["vesicles"] }}</td>
          <td style="width:100px;">{{ $sti_record["recurrent"] }}</td>
          <td style="width:100px;">{{ $sti_record["last_episode"] }}</td>
          <td style="width:100px;">{{ $sti_record["suspects_herpes"] }}</td>
          <td style="width:100px;">{{ $sti_record["ing_lymph_node"] }}</td>
          <td style="width:100px;">{{ $sti_record["ing_lymph_node_hl"] }}</td>
          <td style="width:100px;">{{ $sti_record["unilateal"] }}</td>
          <td style="width:100px;">{{ $sti_record["leg_ulcer"] }}</td>
          <td style="width:100px;">{{ $sti_record["scrotal_swelling"] }}</td>
          <td style="width:100px;">{{ $sti_record["scrotal_swelling_hl"] }}</td>
          <td style="width:100px;">{{ $sti_record["td_ntd"] }}</td>
          <td style="width:100px;">{{ $sti_record["gen_wart"] }}</td>
          <td style="width:100px;">{{ $sti_record["gen_wart_hl"] }}</td>
          <td style="width:100px;">{{ $sti_record["physical_exam"] }}</td>
          <td style="width:100px;">{{ $sti_record["urinated_wit_1h"] }}</td>
          <td style="width:100px;">{{ $sti_record["discharge"] }}</td>
          <td style="width:100px;">{{ $sti_record["discharge_milk"] }}</td>
          <td style="width:100px;">{{ $sti_record["colour"] }}</td>
          <td style="width:100px;">{{ $sti_record["erythema"] }}</td>
          <td style="width:100px;">{{ $sti_record["blisters"] }}</td>
          <td style="width:100px;">{{ $sti_record["gen_ulcer"] }}</td>
          <td style="width:100px;">{{ $sti_record["esti_size"] }}</td>
          <td style="width:100px;">{{ $sti_record["sing_multi"] }}</td>
          <td style="width:100px;">{{ $sti_record["pain_full_less"] }}</td>
          <td style="width:100px;">{{ $sti_record["herpes_suspect"] }}</td>
          <td style="width:100px;">{{ $sti_record["inguinal_bubo"] }}</td>
          <td style="width:100px;">{{ $sti_record["fluctant"] }}</td>
          <td style="width:100px;">{{ $sti_record["tendr_ntender"] }}</td>
          <td style="width:100px;">{{ $sti_record["oth_leg_inf"] }}</td>
          <td style="width:100px;">{{ $sti_record["phy_genital_wart"] }}</td>
          <td style="width:100px;">{{ $sti_record["crab_lice"] }}</td>
          <td style="width:100px;">{{ $sti_record["scabies"] }}</td>
          <td style="width:100px;">{{ $sti_record["gscrotal_swelling"] }}</td>
          <td style="width:100px;">{{ $sti_record["estimated_siz"] }}</td>
          <td style="width:100px;">{{ $sti_record["unilateal_bilateral"] }}</td>
          <td style="width:100px;">{{ $sti_record["gtender_ntender"] }}</td>
          <td style="width:100px;">{{ $sti_record["erythem"] }}</td>
          <td style="width:100px;">{{ $sti_record["des_size"] }}</td>
          <td style="width:100px;">{{ $sti_record["tbl_treat_diagnosis_first_visit"] }}</td>
          <td style="width:100px;">{{ $sti_record["epi_discharge"] }}</td>
          <td style="width:100px;">{{ $sti_record["unprot_sex_new_part"] }}</td>
          <td style="width:100px;">{{ $sti_record["genital_signs"] }}</td>
          <td style="width:100px;">{{ $sti_record["presumptive_diag"] }}</td>
          <td style="width:100px;">{{ $sti_record["pri_syphillis"] }}</td>
          <td style="width:100px;">{{ $sti_record["sec_syphillis"] }}</td>
          <td style="width:100px;">{{ $sti_record["chancroid"] }}</td>
          <td style="width:100px;">{{ $sti_record["gen_herpes"] }}</td>
          <td style="width:100px;">{{ $sti_record["gen_scabies"] }}</td>
          <td style="width:100px;">{{ $sti_record["gud_other"] }}</td>
          <td style="width:100px;">{{ $sti_record["other(please specify)"] }}</td>
          <td style="width:100px;">{{ $sti_record["Gonorhoea"] }}</td>
          <td style="width:100px;">{{ $sti_record["non_gono_urethritis"] }}</td>
          <td style="width:100px;">{{ $sti_record["non_gono_procti"] }}</td>
          <td style="width:100px;">{{ $sti_record["trichomonas"] }}</td>
          <td style="width:100px;">{{ $sti_record["genital_candidiosis"] }}</td>
          <td style="width:100px;">{{ $sti_record["beterial_vaginosis"] }}</td>
          <td style="width:100px;">{{ $sti_record["congenial_syphillis"] }}</td>
          <td style="width:100px;">{{ $sti_record["latent_syphillis"] }}</td>
          <td style="width:100px;">{{ $sti_record["molluscum_contag"] }}</td>
          <td style="width:100px;">{{ $sti_record["bubos"] }}</td>
          <td style="width:100px;">{{ $sti_record["othstd_genital_warts"] }}</td>
          <td style="width:100px;">{{ $sti_record["ostd_other"]}}</td>
          <td style="width:100px;">{{ $sti_record["tre_azythro"] }}</td>
          <td style="width:100px;">{{ $sti_record["tre_cefixim"] }}</td>
          <td style="width:100px;">{{ $sti_record["tre_ciprofloxacin"] }}</td>
          <td style="width:100px;">{{ $sti_record["tre_tinidazole"] }}</td>
          <td style="width:100px;">{{ $sti_record["tre_fluconazole"] }}</td>
          <td style="width:100px;">{{ $sti_record["tre_doxycycline"] }}</td>
          <td style="width:100px;">{{ $sti_record["tre_ceftriaxone"] }}</td>
          <td style="width:100px;">{{ $sti_record["tre_benz_pen"] }}</td>
          <td style="width:100px;">{{ $sti_record["no_treat"] }}</td>
          <td style="width:100px;">{{ $sti_record["al_Penicillin"] }}</td>
          <td style="width:100px;">{{ $sti_record["al_sulfa"] }}</td>
          <td style="width:100px;">{{ $sti_record["part_treat"] }}</td>
          <td style="width:100px;">{{ $sti_record["condom_giv"] }}</td>
          <td style="width:100px;">{{ $sti_record["tre_remarks"] }}</td>
          <td style="width:100px;">{{ $sti_record["followup"] }}</td>
          <td style="width:100px;">{{ $sti_record["clinician_name"] }}</td>
