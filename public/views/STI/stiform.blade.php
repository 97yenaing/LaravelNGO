...
<body> <!--onload="findRegisterData()" onlod function change form gender//yenaing -->
  <div class="container containers assist-sti ">
    ...
    <ul class="nav nav-tabs toggle sti-colist" id="hidden-title">
      ...
      <li>
        <a class="nav-link toggle-link" data-toggle="pill" onclick="" href="#menu6">Export</a>
      </li>
      <li>
    ...
    <div class="tab-content assist-parent-div">
        ...
        <div class="followup phyExam-section" id="followup">
          ...
          <div class="row sti-female sti-phyfemale" id="stiPhy-femaleID"><!-- female -->
            ...
            <div class="col-sm-12" id="f31">
              <label for="validationCustom01" class="form-label">Genital_ucl Location</label>
      ...
      <div class="tab-pane container containers fade" id="menu6">
        <form action="{{ route('sti_export') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <br>
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-md-2">
              <select class="form-control" name="STI_data">
                <option value="1">With results in text</option>
            ...
            <div class="col-md-2">
              ...
              <div class="date-holder">
                <input type="text" id="ddFrom" name="Datefrom" class="form-control Gdate" placeholder="dd-mm-yyyy">
                <img src="../img/calendar3.svg" class="dateimg" alt="date">
              </div>
            </div>
            <div class="col-md-1">
            ...
            <div class="col-md-2">
              ...
              <div class="date-holder">
                <input type="text" id="ddTo" name="Dateto" class="form-control Gdate" placeholder="dd-mm-yyyy">
                <img src="../img/calendar3.svg" class="dateimg" alt="date">
              </div>
            </div>
            <div class="col-sm-3">
          ...
          if (response.length > 2) {
            ...
            if (countResponse > 0) {
              ...
              if (r0 > 0) { /////////////////////////////////////////////////////// ====>>>>>>>>>>>>>>> Need to change "r0"
                document.getElementById('age').innerHTML = response[0]["Agey"];
            ...
            if (r1 > 0) { // Male
              ...
              for (var male_row = 0; male_row < r1; male_row++) {
                ...
                var but_ton0 = "<button onclick='stiupdated()' class='sti-update-button btn btn-warning' id=sti_maleUp_" + response[1][male_row]['id'] + ">" + "GO-Updated" + "</button>" +
                  "<button onclick='stiremove()' class='sti-removeBtn-male btn btn-danger'id=sti_maleDel_" + response[1][male_row]['id'] + ">" + "Delete Row" + "</button>";
            ...
            if (r2 > 0) { //Female
              ...
              for (var female_row = 0; female_row < r2; female_row++) {
                ...
                var but_ton0 = "<button onclick='stiupdated()' class='sti-update-button btn btn-warning' id=sti_femaleUp_" + response[2][female_row]['id'] + ">" + "GO-Updated" + "</button>" +
                  "<button onclick='stiremove()' class='sti-removeBtn-male btn btn-danger'id=sti_femaleDel_" + response[2][female_row]['id'] + ">" + "Delete Row" + "</button>";
