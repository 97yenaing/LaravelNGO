            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td style="width:50px;">{{ $value['vdate'] }}</td>
                    <td style="width:50px;">{{ $value['Patient_Type'] }}</td>
                    <td style="width:50px;">{{ $value['Patient Type Sub'] }}</td>
                    <td style="width:50px;">{{ $value['st_stool'] }}</td>
                    <td style="width:50px;">{{ $value['st_colour'] }}</td>
                    <td style="width:50px;">{{ $value['wbc_pus_cell'] }}</td>
                    <td style="width:50px;">{{ $value['st_consistency'] }}</td>
                    <td style="width:50px;">{{ $value['st_rbcs'] }}</td>
                    <td style="width:50px;">{{ $value['st_other'] }}</td>
                    <td style="width:50px;">{{ $value['st_comment'] }}</td>
                    <td style="width:50px;">{{ $value['st_lab_tech'] }}</td>
                    <td style="width:50px;">{{ $value['st_issue_date'] }}</td>
