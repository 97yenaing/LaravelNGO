      ...
      <div class="tab-content lab-containers lab-diseaseSection no-margin">
        ...
        <div class="tab-pane container fade lab-incon-div" id="oi">
          ...
          <div class="row oi-indLink">
            <div class="col-sm-3 oi-csf" >
              <label class="form-label">CSF Smear Type</label>
      ...
      <div id="toshowResult_all" style="border: 1px solid #000000;" class='printAll-dispaly'>
        <div class="row no-margin print-HeadDiv">
          <div class="col-sm-12 print_allHeader">
            ...
            <b style="float:right;font-size:40;">C2</b>
        ...
        <div class="clearfix">
          ...
          <div class="row no-margin pirntAll-colDT">
            <div class="col-sm-8 no-margin">Specimen collection<br> date & time</div>
            <div class="col-sm-4 no-padding  no-margin"id="printAll_collectionDT"></div>
        ...
        <div>
          ...
          <div class="row no-margin">
            ...
            <div class="col-sm-1  no-margin"></div>
            <div class="col-sm-2 print_data no-margin">Gram stain</div>
          ...
          <div class="row no-margin">
            ...
            <div class="col-sm-2 print_data no-margin" id="allgeneral_malMicroscopy1">-</div>
            <div class="col-sm-3  print_data no-margin"id="allgeneral_malMicroscopy2">-</div> 
          </div>
          <div class="row no-margin">
            <div class="col-sm-2 print_data no-margin">Appearance</div>
          ...
          <div class="row no-margin">
            ...
            <div class="col-sm-10 print_data no-margin"><u id="allLab_remark">-</u></div>
          </div>
          <div class="row no-margin">
                        ...
                        success:function(response){
                            ...
                            if(patientData.length!=0){
                              ...
                              if(stiprint.length>0){
                                ...
                                var other_status=stiprint[0]['wetoth']+"/"+
                                                stiprint[0]['uoth']+"/"+stiprint[0]['pfother']+"/"+
                                                stiprint[0]['eother']+"/"+stiprint[0]['rother']+"/"+stiprint[0]['Other Bacteria']
                                $("#allSti_other").text(other_status);
                              ...
                              if(urineprint.length>0){
                                ...
                                $("#allurine_colour").text(urineprint[0]['Ucolor']);
                                $("#allurine_appearance").text(urineprint[0]['Uapp']);
...
function gramChange(){
  var type=$("#csf_smear").val();
        if(type=='Gram'){
          ...
          $("#giemsa_stain_result,#india_ink_result").prop("disabled",true);
        }
}
...
function ptData(){
  ...
  document.getElementById('printAll_date').value = today;
  // End of Date
...
function viral_load(){
  ...
  if(cid.length>8 && viral_load_result.length >1 && present==1){
    if (confirm("Are you sure you want to do save?")) {
        $.ajaxSetup({
          headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
...
function row_num(){// to get row ID from follow up History
  ...
  selected_Date=formatDate(selected_Date);
  var drawData = 1;
  var ckdata = {
    drawData:drawData,
    PtID:PtID,
    ...
    success:function(response){
      ...
      if(response[14].length>0){
        ...
        for (var i = 0; i < response[14].length; i++) {
          ...
          +"<td >"+printDate+"</td>"
          //+"<td>"+""+"</td>"
          +"<td id='"+btnName+"'>"+ "<a  data-toggle='tab'  onclick='row_num()' class='nav-link btn btn-warning labUpdate-btn'>"+" Update Data"+"</a>"+"</td>"
          +"</tr>";
...
function mainFiller(selected_Date){
  ...
  for (var i = 0; i < resp[10].length; i++) {
    ...
    if(headerOK=="viral"){
      ...
      document.getElementById("Ptype").innerHTML=resp[10][i]["Main-Risk"];
      document.getElementById("ext").innerHTML=resp[10][i]["Sub-Risk"];
