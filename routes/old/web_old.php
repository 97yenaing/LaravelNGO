...
Route::get('Reception/Reception', [ReceptionController::class, 'Hty_A_Recession_View']);
Route::post('Reception/Reception', [ReceptionController::class, 'hty_A_Recession_data'])->name('htyAform');

Route::get('Reception/patients', [ReceptionController::class, 'patients'])->name('htyA-patients');
Route::get('Reception/generalPatient', [ReceptionController::class, 'general_patients'])->name('gt-patients');
...
//Route::post('import/GeneralPatientImport', [ReceptimportController::class,'generalPatient']);
Route::post('import/GeneralPatientImport', [ReceptimportController::class,'generalPatient1'])->name('general_import');
...
Route::get('import/passport', [ReceptimportController::class,'passport_view']);
...
Route::get('STI/sti-patients',[StiController::class,'sti_patients']);
