...
class CreateNcdPatientRegistersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ncd__patient__registers', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ncd__patient__registers');
    }
}
