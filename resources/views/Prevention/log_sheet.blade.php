...
<body>
    ...
    <div class="container containers">
        <ul class="nav nav-tabs toggle" id="hidden-title" >
                <li class="nav-item">
                <a class="nav-link active toggle-link c_fid" data-toggle="tab" href="#confid" >Confidential Facts</a>
                </li>
                <li class="nav-item">
                <a class="nav-link toggle-link l_sheet" data-toggle="tab" href="#log_sheet" >Log Sheet</a>
                </li>
                <li class="nav-item">
                <a class="nav-link toggle-link nav_follow" data-toggle="tab" href="#follow" >Follow up history</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link toggle-link nav_export" data-toggle="tab" href="#export" >Export</a>
                </li>
    ...
    <div id="hider0" class="container containers page-color" >  <!-- *adding containers clss -->
            <div class="tab-content">
                <!-- Confidential Entry -->
                <div class="tab-pane container containers  active" id="confid">
                    <div class="row justify-content-center">
                        <div class="col-md-12 "  >
                            <h2 class="header-text confidential-head">Confidential Facts
                              <label for="" class="form-label confidental-head-label" id="confi-newOld"></label>
                            </h2>
                        </div>
                    </div>
                    <div class="row">     
                        ...
                        <div class="col-md-2">
                            ...
                            <input  type="number" id="pt_code"  class="form-control">
                        </div>
                        <div class="col-md-1">
                            <button onclick="peerCode()"class="prev-combine"> Search</button>
                        </div>
                        <div class="col-md-1">
                            <label for="">>>></label>
                        ...
                        <div class="col-md-1 consulor-mainrisk">
                            ...
                            <input id="risk_change_checkbox" type="checkbox" onchange="risk_change_date()" value="yes">
                        </div>

                        <div class="col-md-1 " id="risk_really_change" style="display: none">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 reception-code1">
                            ...
                            <label  autofocus id="gid" class="form-control" ></label>
                        </div>
                    ...
                    <div class="row recepatient-info">
                        <div class="col-md-2 reception-visitDate">
                          <label  class="form-label" id ="regDateText">Registration Date</label>
                          <div class="date-holder">
                              <input type="text" id="register_date" class="form-control Gdate date-verify " onchange="reg_date_change()"  placeholder="dd-mm-yyyy">
                        ...
                        <div class="col-md-2 reception-visitDate">
                           <label  class="form-label">Date Of Birth</label>
                            <div class="date-holder">
                                <input type="text" id="dob" class="form-control Gdate reception-dateformat " placeholder="dd-mm-yyyy">
                                <img src="../img/calendar3.svg" class="dateimg" alt="date">
                            </div>
                        </div>
                        
                        <div class="col-md-2">
                          <label for="" class="form-label">Register Age(year)</label>
                          <input type="number" id="agey_register" class="form-control" onblur="reg_age_change()">
                        </div>
                        <div class="col-md-2">
                          <label for="" class="form-label">Register Age(month)</label>
                          <input type="number"  class="form-control" id="agem_register">
                        </div>
                        <div class="col-md-2" >
                        ...
                        <div class="date-holder">
                                <input type="text" disabled id="risk_change_date" class="form-control Gdate  "  placeholder="dd-mm-yyyy">
                                <img src="../img/calendar3.svg" class="dateimg" alt="date">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-2 reception-re-fo">
                            <button type="button" style="display:none;" id="regbutton"  onclick="confidentialSave(1)" class="btn btn-primary reception-register">Register</button>
                            <button type="button" style="display:none;" id="updatebutton" onclick="confidentialSave(2)" class="btn btn-primary reception-register">Update</button>
                        </div>
                    </div>
                </div>
                <!-- Log Sheet -->
                <div class="tab-pane container containers fade" id="log_sheet">
                    <div class="log-sheetSection">
                      <br>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <input id="log_sheet_ID_change" type="checkbox" onchange="show_update_ID_box()">If need to change General ID
                            </div>
                            <div class="col-md-2">
                                <input type="number" placeholder="General ID" id="updateID" class="form-control">
                            </div>
                            <div class="col-md-1">
                                <button type="button" onclick="serarch_change()" id="log_serach_chagne"  class="btn btn-primary logsheet_id_change_btn">Search</button>
                            </div>
                        </div>
                        <div class="log-first">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="date-holder">
                                        <input type="text" id="vDate" required class="form-control Gdate date-verify" onblur="define_new_old()"  placeholder="dd-mm-yyyy">
                                        <img src="../img/calendar3.svg" class="dateimg" alt="date">
                                    </div>
                                </div>
                                <div class="col-md-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <select class="form-control" id="serve_pro_1">
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                  <div class="dropdown col-md-2 he-checkbox"  id="he_check" >
                                      <button class="btn btn-secondary dropdown-toggle he-sesion"  type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                      HE Session
                                      </button>
                                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" >
                                          ...
                                          <label class="dropdown-item">
                                          <input type="checkbox"id="he_sti" onchange="hecheck()" value="STI(2)"> STI(2)
                                          </label>
                                          <label class="dropdown-item">
                                          <input type="checkbox"id="he_safe_inj" onchange="hecheck()" value="Safe injection(3)"> Safe injection(3)
                                          </label>
                                          <label class="dropdown-item">
                                          <input type="checkbox"id="he_safe_sex" onchange="hecheck()" value="Safe sex(4)"> Safe sex(4)
                                          </label>
                                          <label class="dropdown-item">
                                          <input type="checkbox" id="he_mmt" onchange="hecheck()" value="MMT(5)"> MMT(5)
                                          </label>
                                          <label class="dropdown-item">
                                          <input type="checkbox"id="he_tb" onchange="hecheck()" value="TB"> TB
                                          </label>
                                          <label class="dropdown-item">
                                          <input type="checkbox"id="he_family_planning" onchange="hecheck()" value="Family Planning"> Family Planning
                                          </label>
                                          <label class="dropdown-item">
                                          <input type="checkbox"id="he_overdose" onchange="hecheck()" value="Overdose"> Overdose
                                          </label>
                                          <label class="dropdown-item">
                                          <input type="checkbox"id="he_hcv" onchange="hecheck()" value="HBV HCV"> HBV HCV
                                          </label>
                                      </div>
                                  </div>
                              ...
                              <div class="col-md-2">
                                  <select class="form-control" id="hiv_status" onchange="hiv_status()">
                              ...
                              <div class="col-md-2" id="hiv_status_sub_div" style="display:none">
                                  <select class="form-control" id="hiv_status_sub">
                                    <option value=""></option>
                                    <option value="2.1">tested < 6 month ago 2.1 </option>
                    ...
                    <div class="log-second">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                    <select class="form-control" id="hts_test">
                                        <option value="-"></option>
                                        <option value="Yes">Yes</option>
                                        <option value="No">No</option>
                                    </select>
                            ...
                            <div class="col-md-2">
                                    <select class="form-control" id="hiv_result">
                                    <option value="-"></option>
                            ...
                            <div class="col-md-2">
                                <div class="date-holder">
                                    <input type="text" id="hiv_comfirm_date"class="form-control Gdate date-verify "  placeholder="dd-mm-yyyy">
                                    <img src="../img/calendar3.svg" class="dateimg" alt="date">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="col-md-2">
                                    <select class="form-control" id="reach_by_whom" onchange="final_Result_confirm()">
                                    <option value="-"></option>
                                ...
                                <div class="col-md-2">
                                    <select class="form-control" id="source_doc" onchange="oneOrtwo()">
                                    <option value="-"></option>
                                ...
                                <div class="col-md-2">
                                  <label for="" class="form-label">Decline Reason</label>
                                </div>
                                <div class="col-md-2">
                                  <select name="" id="Decline_Reason" class="form-select">
                                    <option value=""></option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                ...
                                <div class="col-md-2">
                                  <div class="date-holder">
                                    <input type="text" id="OST_Intial_Date" required="" class="form-control Gdate date-verify " placeholder="dd-mm-yyyy">
                                    <img src="../img/calendar3.svg" class="dateimg" alt="date">
                                  </div>
                                </div>
                        ...
                        <div class="row log-button">
                            <div class="col-sm-2 ">
                                <button type="button" id="logsheet_save" onclick="logSheetSave()" class="btn btn-primary log-save">Log-Sheet_Save</button>      
                            </div>
                        </div>
                    </div>
                    <div class="cbs-Section" id="cbs-section" style="display:none;">
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                <div class="date-holder">
                                        <input type="text" id="vDate2"class="form-control Gdate date-verify "  placeholder="dd-mm-yyyy">
                                        <img src="../img/calendar3.svg" class="dateimg" alt="date">
                                    </div>
                            </div>
                            <div class="col-md-2">
                                <label for="">Meeting Point</label>
                                <input type="text" id="meetingPoint2" class="form-control">
                            </div>
                            <div class="col-md-3">
                                <label for="">Reached KP and their Partners (Cal yr) </label>
                                <span  style="background-color:orange;" class="form-control" id="reached_kp_partners"></span>
                            </div>
                            <div class="dropdown col-md-2">
                                <button class="btn btn-secondary dropdown-toggle cbs-serviceTK" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    Service Provision
                                </button>
                                <div class="dropdown-menu" id="cbs_Check" aria-labelledby="dropdownMenuButton">
                                    <label class="dropdown-item">
                                    <input type="checkbox" onchange="cbs_check()" id="service_pro_he" value="HE"> HE
                                    </label>
                                    <label class="dropdown-item">
                                    <input type="checkbox" onchange="cbs_check()" id="service_pro_condom"value="Condom"> Condom
                                    </label>
                                    <label class="dropdown-item">
                                    <input type="checkbox" onchange="cbs_check()" id="service_pro_nsp" value="NSP"> NSP
                                    </label>
                                    <label class="dropdown-item">
                                    <input type="checkbox" onchange="cbs_check()" id="service_pro_sti" value="STI"> STI
                                    </label>
                                    <label class="dropdown-item">
                                    <input type="checkbox"id="service_pro_cbs"  onchange="cbs_check()" value="CBS counselling"> CBS Counselling
                                    </label>
                                </div>
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-control" id="retesting">
                                <option value="-"></option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-control" id="HIV_status_2">
                                  <option value=""></option>
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-control" id="pre_test_counsel">
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                            </div>
                            <div class="col-md-2">
                                ...
                                <select class="form-control" id="post_test_counsel">
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                            </div>
                            <div class="col-md-2">
                                ...
                                <select class="form-control" id="determine_result" onchange="cbs_hiv_determine()" >
                                    <option value="-"></option>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" id="if_reactive_refer" class="form-control">
                                </div>
                            <div class="col-md-4">
                                ...
                                <div class="date-holder">
                                        <input type="text" id="date_arrival_confirm_facility" class="form-control Gdate date-verify "  placeholder="dd-mm-yyyy">
                                        <img src="../img/calendar3.svg" class="dateimg" alt="date">
                                    </div>
                            </div>
                            <div class="col-md-3">
                                ...
                                <select class="form-control" id="hiv_status_after_confirm" onchange="cbs_hiv_final_confirm()">
                                <option value="-"></option>
                                    <option value="Positive">Positive</option>
                                    <option value="Negative">Negative</option>
                        ...
                        <div class="row log-button">
                            <div class="col-sm-2 ">
                                <button type="button" id="cbs_save" onclick="cbsSave()" class="btn btn-primary log-save">CBs Save</button>      
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-pane container containers fade" id="export">
                        <br>
                    <form action="{{ route('prevention_data') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        <div class="row justify-content-center">
                            <h1>Export</h1>
                        </div><br>
                        <div class="row justify-content-center">
                                <div class="col-md-2">
                                    <select  id="tb_name" name ="tb_name" class="form-control">
                                ...
                                <div class="date-holder">
                                            <input type="text" id="ddFrom" name="ddFrom" class="form-control Gdate  "  placeholder="dd-mm-yyyy">
                                            <img src="../img/calendar3.svg" class="dateimg" alt="date">
                                        </div>
                                </div>
                                <div class="col-md-1">
                                ...
                                <div class="date-holder">
                                            <input type="text" id="ddTo" name="ddTo" class="form-control Gdate date-verify  "  placeholder="dd-mm-yyyy">
                                            <img src="../img/calendar3.svg" class="dateimg" alt="date">
                                        </div>
                                </div>
                                <div class="col-sm-3" >
                                    <button class="btn btn-dark" id="prev_export" >Export</button>
                                </div>
                        </div><br>
                        <div class="row">
                        ...
                        <div>
                          <input name="functionLoco" style="display:none" value="15"></input>
                        </div>
                        <br>
                    </form>
                </div>
...
<script type="text/javascript" language="javascript">
  let generatedID=0; let text =0; let ptID=0;let rowNumber=0; let year =0;let Age=0;
  let generatedID1=0;
  let genID=[];
  let ddDate=0; let resp ;let LS_updateSignal=0; let Ls_ID_change=0; let hts_date=0;
  let log_seleName=[
    'substainRisk',
    'serProvi_1','serProvi_2','serProvi_3','hiv_status1','hiv_status2',
    'Hts_done','final_result','test_clinic','reach_whom','source_doc','Mental_Health','PHQ4_1_2','PHQ4_3_4','OST_done','OST_accept','decline_reason'
  ];
  let log_inputName=[
    'updateIDchange','vdate','meet_point','ns_distru',
    'comdome_male','comdome_female','ns_return',
    'date_comfirm','OST_inital_date','log_remark',
  ];
      ...
      $.ajax({
          ...
          success:function(response){
              ...
              if(response[13]!="no data"){
                  ...
                  var result_body1 =
                  "<tr style='background-color:#A7DBD8; color:#000000;'"+ "id='"+rowName+"' class='log_sheet_hisData'>"
                  // +"<td id='updateSerial1'>"+srNum+"</td>"
                      ...
                      +"<td class= tablet-pc id='"+btnName+"'>"+"<button class='btn btn-info btn-primary log-sheet-edit' onclick='row_num(1)' id='logsheet_edit_"+response[13][i]['id']+"'>"+ "Edit Log Sheet"+"</button>"+
                        "<button class='btn btn-info btn-danger' onclick='row_num(1)' id='logsheet_remove_"+response[13][i]['id']+"'>"+ "Delete Data"+"</button>"+"</td>"
                  +"</tr>";
              ...
              if(response[14]!="no data"){
                  ...
                  var result_body2 =
                  "<tr style='background-color:#A7DBD8; color:#000000;'"+ "id='"+rowName2+"' class='cbs_hisData'>"
                  // +"<td id='updateSerial1'>"+srNum+"</td>"
                      +"<td class='tablet-pc' >"+(i+1)+"</td>"
                      +"<td id='col_3'>"+response[14][i]['Pid']+"</td>"
                      +"<td >"+(response[14][i]['Visit_Date'])+"</td>"
                      //  +"<td >"+response[0][i]['Main Risk']+"</td>"
                      +"<td class= tablet-pc id='"+btnName2+"'>"+"<button  class='btn btn-info btn-primary log-sheet-edit' onclick='row_num(2)' id='logsheet_edit_"+response[14][i]['id']+"'>"+ "Edit CBS"+"</button>"+
                        "<button class='btn btn-info btn-danger' onclick='row_num(2)' id='CBS_remove_"+response[14][i]['id']+"'>"+ "Delete Data"+"</button>"+"</td>"
                  +"</tr>";
              ...
              //$(".appointment-table p").empty();
                  ...
                  if(response[1]!=null){
                        ...
                        // +"<td id='updateSerial1'>"+srNum+"</td>"
                            ...
                            //  +"<td >"+response[0][i]['Main Risk']+"</td>"
                            +"<td class= tablet-pc >"+"<button class='btn btn-info btn-primary log-sheet-edit' onclick='row_num(1)' id='logsheet_edit_"+response[1]['id']+"'>"+ "Edit Log Sheet"+"</button>"+
                              "<button class='btn btn-info btn-danger' onclick='row_num(1)' id='logsheet_remove_"+response[1]['id']+"'>"+ "Delete Data"+"</button>"+"</td>"
                        +"</tr>";
                        $("#list").append(result_body1);
  ...
  function cbsSave() {
    ...
    update();
      ...
      var cbs_name=['retesting','HIV_status_2','pre_counsel','post_counsel','hiv_determine','hiv_final','service','mode',];
      var cbs_data={};
                  ...
                  if(response[0]==false){
                    ...
                    if(response[1]!=""){
                      ...
                      // +"<td id='updateSerial1'>"+srNum+"</td>"
                          ...
                          //  +"<td >"+response[0][i]['Main Risk']+"</td>"
                          +"<td class= tablet-pc id='"+btnName2+"'>"+"<button  class='btn btn-info btn-primary log-sheet-edit' onclick='row_num(2)' id='logsheet_edit_"+response[1][i]['id']+"'>"+ "Edit CBS"+"</button>"+
                            "<button class='btn btn-info btn-danger' onclick='row_num(2)' id='CBS_remove_"+response[1][i]['id']+"'>"+ "Delete Data"+"</button>"+"</td>"
                      +"</tr>";
                      $("#list2").append(result_body2);
                    }
                }
  ...
  function row_num(section){// to get row ID from follow up History
      ...
      // }
        ...
        hts_date =formatDate($(event.target).parent().parent().children().eq(2).text());// collecting id of the targeted parent
              ...
              for(var i=0;i<service_provision.length;i++){
                ...
                $(".cbsCheck-span").text(he_text+"\t"+service_provision[i]+"/");
                  ...
                  //  $("#reached_kp_partners").val(response[0][""]);
                    ...
                    $("#determine_result").val(response[0]["HIV_determine_result"]);// HIV status in controller
  ...
  function hiv_status(){
    ...
    if(hiv_status==2){
      $("#hiv_status_sub_div").show();
        ...
        var id={ ptid:knownNeg_ID,functionLoco:functionLoco,vdate:vdate};
        console.log(id);
  ...
  function show_update_ID_box(){
    $("#log_sheet_ID_change").prop("checked") ?$("#log_serach_chagne").text("Change")  :$("#log_serach_chagne").text("Search") ;
  }
  function serarch_change(){
      ...
      var ckdata = {  ptID_Change:ptID_Change,
                      functionLoco:functionLoco,
                    };
  ...
  function cbs_hiv_final_confirm(){
    ...
    if(hiv_confirm_date.length>9 && $("#hiv_status_after_confirm").val().length>5&&$("#test_clinic").val()=="HTY-C2"){
