      ...
      <table>
        <thead>
          <tr>
            ...
            <th style="background-color:#a6a6a6;">Mpox suspected</th>
            <th style="background-color:#a6a6a6;">Mpox suspected Rash</th>
            <th style="background-color:#a6a6a6;">Further Mx</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="width:200px;">{{ $users1[$index]['Mpox_suspected'] }}</td>
            <td style="width:200px;">{{ $users1[$index]['Mpox_sus_rash'] }}</td>
            <td style="width:200px;">{{ $users1[$index]['Mpox_mx'] }}</td>
