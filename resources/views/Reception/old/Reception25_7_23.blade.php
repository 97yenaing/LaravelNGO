          ...
          @endforeach
            ...
            <div class="col-md-1 reception-clinic" >
              ...
              <div class="row">
                ...
                <div class="col-md-1">
                  <button onclick="peerCode()" class="code-combine"> Combine</button>
                </div>
              ...
              <div class="row recepatient-info">
                ...
                <div class="col-md-2 reception-visitDate">
                  <label  class="form-label">Visit Date(dd-mm-yyyy)</label>
      ...
      <div class="tab-pane container containers fade" id="return">
       ...
       @csrf
        ...
        <div class="row ">      <!-- justify-content-center -->
                ...
                <div class="col-sm-2 return-input ">
                  <label for="validationCustom01" class="form-label">Next Appointment Date(dd-mm-yyyy)</label>
        ...
        <div>
          ...
          <div class="row reception-appointmentInfo ">
            <div class="col-sm-4 appointment-date">
              <label for="validationCustom01" class="form-label appointment-label">Next Appointment Date(dd-mm-yy)</label>
