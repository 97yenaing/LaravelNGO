...
@auth
<form action="{{ route('server_risk_log_data') }}" method="post" class="container containers">
  @php
  ...
  <div class="page-color riskLog-section">
    <div class="row">
      <div class="col-sm-2">
        <label for="" class="form-label">Clinic</label>
        <select name="clinic_road" id="" class="form-select">
          <option value="0" {{ old('clinic_road')=='0' ? 'selected' : '' }}>HTY-A</option>
          <option value="1" {{ old('clinic_road')=='1' ? 'selected' : '' }}>HTY-C1</option>
          <option value="2" {{ old('clinic_road')=='2' ? 'selected' : '' }}>HTY-C2</option>
          <option value="3" {{ old('clinic_road')=='3' ? 'selected' : '' }}>HTY-B</option>
          <option value="4" {{ old('clinic_road')=='4' ? 'selected' : '' }}>SPT</option>
          <option value="5" {{ old('clinic_road')=='5' ? 'selected' : '' }}>SDG</option>
          <option value="6" {{ old('clinic_road')=='6' ? 'selected' : '' }}>TL</option>
        </select>
        @error('clinic_road')
