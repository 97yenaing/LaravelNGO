      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="width:80px;">{{ $value["Diagnosis_data"]['phacheck'] }}</td>
            <td style="width:80px;">{{ $value["Diagnosis_data"]['pha_new_old'] }}</td>
            <td style="width:80px;">{{ $value["Diagnosis_data"]['pha_cohort'] }}</td>

            <td style="width:80px;">{{ $value["Diagnosis_data"]['artcheck'] }}</td>
            <td style="width:80px;">{{ $value["Diagnosis_data"]['art_new_old'] }}</td>
            <td style="width:80px;">{{ $value["Diagnosis_data"]['art_cohort'] }}</td>

            <td style="width:80px;">{{ $value["Diagnosis_data"]['prepcheck'] }}</td>
            <td style="width:80px;">{{ $value["Diagnosis_data"]['prep_new_old'] }}</td>

            <td style="width:80px;">{{ $value["Diagnosis_data"]['pmtctcheck'] }}</td>
            <td style="width:80px;">{{ $value["Diagnosis_data"]['pmtct_new_old'] }}</td>

            <td style="width:80px;">{{ $value["Diagnosis_data"]['anccheck'] }}</td>
            <td style="width:80px;">{{ $value["Diagnosis_data"]['anc_new_old'] }}</td>

            <td style="width:80px;">{{ $value["Diagnosis_data"]['fmaplancheck'] }}</td>
            <td style="width:80px;">{{ $value["Diagnosis_data"]['famaplan_new_old'] }}</td>

            <td style="width:80px;">{{ $value["Diagnosis_data"]['gneralcheck'] }}</td>
            <td style="width:80px;">{{ $value["Diagnosis_data"]['general_new_old'] }}</td>
            <td style="width:80px;">{{ $value["Diagnosis_data"]['general_diagnosis'] }}</td>
            @if(array_key_exists("OPD",$value["Diagnosis_data"]))
            <td style="width:80px;">{{ $value["Diagnosis_data"]['OPD'] }}</td>
            @else
            ...
            <td style="width:80px;">{{ $value["Diagnosis_data"]['ncdcheck'] }}</td>
            <td style="width:80px;">{{ $value["Diagnosis_data"]['ncd_new_old'] }}</td>
            <td style="width:80px;">{{ $value["Diagnosis_data"]['ncd_diagnosis'] }}</td>
            <td style="width:80px;">{{ $value["Diagnosis_data"]['ncd_drugSupply'] }}</td>

            <td style="width:80px;">{{ $value["Diagnosis_data"]['hivTBcheck'] }}</td>
            <td style="width:80px;">{{ $value["Diagnosis_data"]['hivTB_new_old'] }}</td>

            <td style="width:80px;">{{ $value["Diagnosis_data"]['fcentercheck'] }}</td>
            <td style="width:80px;">{{ $value["Diagnosis_data"]['feedcentre_new_old'] }}</td>

            <td style="width:80px;">{{ $value["Diagnosis_data"]['labInvestcheck'] }}</td>
            <td style="width:80px;">{{ $value["Diagnosis_data"]['labInvest_new_old'] }}</td>
