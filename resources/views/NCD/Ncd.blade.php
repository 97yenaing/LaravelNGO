  ...
  <ul class="nav nav-tabs toggle  ncd-list"
    ...
    <li class="nav-item">
      <a class="nav-link active toggle-link "
        data-toggle="tab"
        href="#ncdRegister">NCD Register</a>
    </li>
    <li class="nav-item">
      <a class="nav-link toggle-link "
        data-toggle="tab"
        href="#ncd_export">Ncd Export</a>
    </li>
  </ul>
  <div class="tab-content page-color">
    <div class="tab-pane ncd-Section active"
      id="ncdRegister">
      <div id="ncd_followList"
        class="ncd-followList">
        <div class="row no-margin">
          <h2>NCD Follow Up History
            <button class="btn ncd-cancelBtn"
              id="ncd_followCancel"
              onclick="Follow_cancel()"
              style="float: right;background-color: beige;">To Register</button>
          </h2>
      ...
      <div id="ncd_existing">
        <div class="header-text">
          ...
          <button class="btn btn-info ncd_followview"
            id="ncd_followView">Follow up History</button>
          <button class="btn btn-info ncd_Addfollow"
            id="ncd_followAdd">Add Follow Up</button>
          <button class="btn btn-warning ncd-refresh"
            onclick="next()">Next Patient</button>
        </div><!-- header -->
        <div class="row">
          <div class="col-sm-3 ncd_RIdchange">
            <input type="checkbox"
              value="ncd Reg Id change"
              id="ncd_regIDchange">
        ...
        <div class="ncd-Diagnosi">
          ...
          <div class="row">
            ...
            <div class="col-sm-2">
              <label class="form-label">2nd Time FBS</label>
              <input type=""
                class="form-control"
                id="2nd_rbs">
            </div>
            <div class="col-sm-2">
              <label class="form-label">2nd Time FBS Date</label>
              <div class="date-holder">
                <input type="text"
                  class="form-control Gdate"
                  id="2ndRBs_Date"
          ...
          <div class="row">
            <div class="col-sm-2">
              ...
              <select class="form-select speDetermine-1"
                id="ncdClinic_sym">
                <option value=""></option>
            ...
            <div class="col-sm-8">
              ...
              <input type="text"
                class="form-control limit-input speDetermine-2"
                id="clinical_sym">
            </div>
            <div class="col-sm-2">
        ...
        <div class="current-ncdMedic">
          ...
          <div class="row">
            ...
            <div class="col-sm-2">
              <input type="text"
                class="form-control" id="ncdhydro_duration">
            </div>
            <div class="col-sm-2">
              <select class="form-select"
                id="ncdhydro_durUnit">
          ...
          <div class="row">
            ...
            <div class="col-sm-1">
              <select class="form-select speDetermine-3 "
                id="ncdother_medic">
                <option value=""></option>
                <option value="Yes">Yes</option>
                <option value="No">No</option>
            ...
            <div class="col-sm-6">
              <input type="text"
                class="form-control limit-input  speDetermine-4"
                id="specifyNcd">
            </div>
          </div>
        ...
        <div class="ncd_patientHist">
          ...
          <div class="row">
            <div class="col-sm-3">
              ...
              <select class="form-select speDetermine-5"
                id="ncdPat_recurIf">
                <option value=""></option>
                <option value="Yes">Yes</option>
                <option value="No">No</option>
            ...
            <div class="col-sm-6">
              ...
              <input class="form-control limit-input speDetermine-6"
                type="text"
                id="ncdPat_commentIf">
            </div>
          </div>
        ...
        <div class="ncd_btn">
          <button onclick="ncdRecord(this)"
            class="btn btn-info ncd_recordSave"
            id="ncd_RegisterBtn">Save Record</button>
          <button onclick="remove_register()"
            class="btn btn-danger"
            style="display: none"
            id="ncd_remove_Register">Delete_Register</button>
        </div>

      </div>

      <div id="ncdfollow_upAdd"
        style="display:none">
        <div class="header-text">
          <div class="ncd_followTime">
          ...
          <button class="btn btn-info ncd_followview"
            id="ncd-toRegister">To-Register</button>
        </div> <!-- header -->
        ...
        <div>
          ...
          <div class="admis-ncdFollow">
            <div class="row">
              <div class="col-sm-2">
                ...
                <select class="form-select speDetermine-7"
                  id="ncdV_Type_currentVisit">
                  <option value=""></option>
              ...
              <div class="col-sm-3">
                ...
                <div class="input-group no-margin">
                  <input class="form-control limit-input speDetermine-8"
                    id="ncdV_latein">
                  <select class="form-select limit-input speDetermine-8"
                    id="ncdV_lateSpe">
                    <option value=""></option>
                    <option value="days">days</option>
                    <option value="weeks">weeks</option>
          ...
          <div>
            <h3>Blood Sugar / Hypertension monitoring</h3>
          </div> <!-- header -->
          ...
          <div class="ncdv-PhysicalEx">
            ...
            <div class="row">
              ...
              <div class="col-sm-2">
                <input type="text"
                  class="form-control"
                  id="ncdV_Amlo_duration">
              </div>
              <div class="col-sm-2">
                <select class="form-select"
                  id="ncdV_Amlo_durUnit">
                  <option value=""></option>
                  <option value="days">Days</option>
                  <option value="weeks">Weeks</option>
                  <option value="months">Months</option>
            ...
            <div class="row">
              ...
              <div class="col-sm-2">
                <input type="text"
                  class="form-control"
                  id="ncdV_Emala_duration">
              </div>
              <div class="col-sm-2">
                <select class="form-select"
                  id="ncdV_Emala_durUnit">
                  <option value=""></option>
                  <option value="days">Days</option>
                  <option value="weeks">Weeks</option>
                  <option value="months">Months</option>
            ...
            <div class="row">
              ...
              <div class="col-sm-2">
                <input type="text"
                  class="form-control"
                  id="ncdV_ator_duration">
              </div>
              <div class="col-sm-2">
                <select class="form-select"
                  id="ncdV_ator_durUnit">
                  <option value=""></option>
                  <option value="days">Days</option>
                  <option value="weeks">Weeks</option>
                  <option value="months">Months</option>
            ...
            <div class="row">
              ...
              <div class="col-sm-2">
                <input type="text"
                  class="form-control" id="ncdV_hydro_duration">
              </div>
              <div class="col-sm-2">
                <select class="form-select"
                  id="ncdV_hydro_durUnit">
                  <option value=""></option>
                  <option value="days">Days</option>
                  <option value="weeks">Weeks</option>
                  <option value="months">Months</option>
            ...
            <div class="row">
              ...
              <div class="col-sm-2">
                <input type="text"
                  class="form-control"
                  id="ncdV_Aspi_duration">
              </div>
              <div class="col-sm-2">
                <select class="form-select"
                  id="ncdV_Aspi_durUnit">
                  <option value=""></option>
                  <option value="days">Days</option>
                  <option value="weeks">Weeks</option>
                  <option value="months">Months</option>
            ...
            <div class="row">
              ...
              <div class="col-sm-2">
                <input type="text"
                  class="form-control"
                  id="ncdV_Metf500_duration">
              </div>
              <div class="col-sm-2">
                <select class="form-select"
                  id="ncdV_Metf500_durUnit">
                  <option value=""></option>
                  <option value="days">Days</option>
                  <option value="weeks">Weeks</option>
                  <option value="months">Months</option>
            ...
            <div class="row">
              ...
              <div class="col-sm-2">
                <input type="text"
                  class="form-control"
                  id="ncdV_Metf1000_duration">
              </div>
              <div class="col-sm-2">
                <select class="form-select"
                  id="ncdV_Metf1000_durUnit">
                  <option value=""></option>
                  <option value="days">Days</option>
                  <option value="weeks">Weeks</option>
                  <option value="months">Months</option>
            ...
            <div class="row">
              ...
              <div class="col-sm-2">
                <input type="text"
                  class="form-control"
                  id="ncdV_Gli500_duration">
              </div>
              <div class="col-sm-2">
                <select class="form-select"
                  id="ncdV_Gli500_durUnit">
                  <option value=""></option>
                  <option value="days">Days</option>
                  <option value="weeks">Weeks</option>
                  <option value="months">Months</option>
            ...
            <div class="row">
              ...
              <div class="col-sm-2">
                <input type="text"
                  class="form-control"
                  id="ncdV_Gli1000_duration">
              </div>
              <div class="col-sm-2">
                <select class="form-select"
                  id="ncdV_Gli1000_durUnit">
                  <option value=""></option>
                  <option value="days">Days</option>
                  <option value="weeks">Weeks</option>
                  <option value="months">Months</option>
            ...
            <div class="row">
              <div class="col-sm-2">
                ...
                <select class="form-select speDetermine-9"
                  id="ncdV_otherMeication">
                  <option value=""></option>
                  <option value="Yes">Yes</option>
                  <option value="No">No</option>
                </select>
              ...
              <div class="col-sm-7">
                <label class="form-label">If yes,Please specify</label>
                <input class="form-control limit-input speDetermine-10"
                  id="ncdV_othmMspecify">
              </div>
              <div class="col-sm-3">
            ...
            <div class="row">
              ...
              <div class="col-sm-3"
                id="ncd_dead_dateBlock" style="display:none">
              ...
              <div class="col-sm-3"
                id="ncd_Tout_phyBlock" style="display:none">
          ...
          <div class="ncd_btn">
            <button onclick="ncdfollowRecord(this)"
              id="ncdV_saveUp"
              class="btn btn-info ncd_recordSave">Save Visit</button>
          </div>
    ...
    <div class="tab-pane  ncd-Section fade"
      id="ncd_export">
      <div class="header-text">
        <h2>NCD Export Section</h2>
      </div>
      <form action="{{ route('ncd') }}"
        method="POST">
        @csrf
        <div class="row " style="justify-content:center;">
          ...
          <div class="col-sm-1"
            style="display:none"><input name="notice"
              value="NCD Export"></div>
          <div class="col-sm-2">
...
<script type="text/javascript"
  language="javascript">
  let ncdRecord_data = {},
    ncdRecord_followdata = {};
  let Clinic_Code, today, ncd_UPsave, rowid, follow_height, follow_update, ncdIdswitch, config;
      ...
      success: function(response) {
        ...
        if (Object.keys(response[1]).length > 1) {
          ...
          for (let ncdf_count = (response[2].length) - 1; ncdf_count >= 0; ncdf_count--) {
            var follow_list = $("<div>").attr({
                class: "row no-margin follow_datalist"
              }).append($("<div>").attr({
                class: "col-sm-2 no-margin"
              }).text(Number(ncdf_count) + 1))
              .append($("<div>").attr({
                class: "col-sm-3 no-margin"
              }).text(response[2][ncdf_count]["Pid"]))
              .append($("<div>").attr({
                class: "col-sm-3 no-margin"
              }).text(response[2][ncdf_count]["Visit_date"]))
              .append($("<div>").attr({
                  class: "col-sm-2 no-margin"
                })
                .append($("<button>").attr({
                  class: "btn btn-info",
                  id: "ncdF_btn_" + response[2][ncdf_count]["id"],
                  onclick: "view_followDetail()"
                }).text("View Detail")))
              .append($("<div>").attr({
                  class: "col-sm-2 no-margin"
                })
                .append($("<button>").attr({
                  class: "btn btn-danger",
                  id: "ncdD_btn_" + response[2][ncdf_count]["id"],
                  onclick: "remove_followDetail()"
                }).text("Delete")));
            $("#ncd_followList").append(follow_list);
          }
          $("#ncd_RegisterBtn").text("Update-Record")
  ...
  function ncd_reg_age() {
    if (config != null && config != "") {
      ...
      if (ncd_redDate.length > 4) {
        ...
        var born_year = config["Reg year"] - config["Agey"];
  ...
  function ncdfollowRecord(button) {
