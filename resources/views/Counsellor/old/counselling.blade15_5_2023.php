              ...
              <div class="row">
               ...
               <div class="col-sm-2 conunselling_type">
                  ...
                  <select class="form-control"id="coun_count" onchange="Counselling_Count()" >
                    <option  value="one">Counselling Only</option>
                    <option selected value="two">HTS Entry and Counselling</option>
                  </select>
               </div>            
              </div>
                ...
                <div class="col-sm-3 labTest-date" style="display:none">
                  ...
                  <div class="input-group mb-2 ">
                    <input type="date" onblur="LabTestDate()" id="labTestDate"  class="form-control" required>
                  </div>
                </div>
                  ...
                  <div class="row hts-entry">
                    ...
                    <div class="col-sm-4 consulor-result consulor-switch">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          <label>RPR</label>
                          <select class="form-control" id="qualitative"  >
                            <option value=""></option>
                            <option value="Reactive">Reactive</option>
                            <option value="Non Reactive">Non Reactive</option>
                          </select>
           ...
           //  processData:false,
             ...
             success:function(response){
               ...
               console.log(response[0].length+"hello length");
                ...
                case 2:alert("This Patient do not Pass Reception Counter");break;
                case 2.1:alert("This Patient do not test Any HTS Test on")
                }
