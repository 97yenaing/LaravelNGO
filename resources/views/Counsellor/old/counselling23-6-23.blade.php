    ...
    <div class="tab-content containers">
                    ...
                    <div class="col-sm-5 consulor-result consulor-switch"><!--HIV -->
                      <div class="row">
                        ...
                        <div class="input-group mb-2 no-margin">
                          ...
                          <div class="input-group-prepend no-margin">
                            <button onclick="hiv_test_date()" class="input-group-text fetch-color">Fetch</button>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                    ...
                    <div class="col-sm-3 consulor-result consulor-switch">
                      <div class="row">
                        ...
                        <div class="input-group mb-2">
                          ...
                          <div class="input-group-prepend no-margin">
                            <button onclick="hepB_test_date()" class="input-group-text fetch-color">Fetch</button>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                    ...
                    <div class="col-sm-4 consulor-result consulor-switch">
                      <div class="row">
                        ...
                        <div class="input-group mb-2">
                          ...
                          <div class="input-group-prepend no-margin">
                            <button onclick="Rrp_test_date()" class="input-group-text fetch-color">Fetch</button>
                          </div>
                        </div>
                      </div>
                      <div class="row">
      ...
      <div class="tab-pane container containers cosulor-parent-div " id="export">
        <h1>Export</h1>
				...
				<br>
				<div class="row ">
					<div class="col-sm-2 counHTS-Formtext">
					...
					<div class="col-sm-1 counHTS-Formtext">
						<label  class="form-label HTS-label">From</label>
					</div>
					<div class="col-sm-2 counHTS-date">
						<input id="from_export" name="dateFrom" type="date" autofocus class="form-control" >
					</div>
					<div class="col-sm-1 counHTS-Totext">
						<label  class="form-label HTS-label">To</label>
					</div>
					<div class="col-sm-2 counHTS-date">
        ...
        $.ajax({
           ...
           //  processData:false,
             ...
             success:function(response){
              ...
              //   case 2.2:alert("This Patient has been Collected in this day");break;
              //   }
