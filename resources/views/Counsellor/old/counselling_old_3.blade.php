...
<div class="container containers ">
    <ul class="nav nav-tabs consulor-list" id="" >
      <li class="nav-item">
        <a class="nav-link active " data-toggle="tab" href="#first" onclick="">General Data</a>
      </li>
      <!-- <li class="nav-item">
        <a class="nav-link  " data-toggle="tab" href="#second" onclick="">HTS Entry</a>
      </li>
      <li class="nav-item">
    ...
    <div class="tab-content containers">
      <div class="tab-pane container containers active cosulor-parent-div" id="first">
        ...
        <label for="">HTS Entry On/Off</label>
        ...
        <label class="switch">
          ...
          <span class="slider round"></span>
              ...
              <div class="row">
                ...
                <div class="col-md-1">
                  <button  class="btn btn-warning update-batton" onclick="ptData()">Search</button>
                </div>

                <div class="col-md-6 consulor-responbox">
              ...
              <div class="row">
                ...
                <div class="col-sm-3 consulor-input-group">
                  <label for="">Counseling Date</label>
                  <div class="input-group mb-2 ">
                    <input type="date"  id="vDate"  class="form-control" required>
                  </div>
                </div>
                <div class="col-md-2 consulor-prepost">
                  <input type="checkbox" id="pre" style=" height: 20px;"  ><span style="background-color: #0F6292;">Pre-test Counselling</span>    <br>
                  <input type="checkbox" id="post"  style=" height: 20px;" ><span style="background-color: #0F6292; color:#16FF00"> Post-test Counselling</span>
                </div>
              ...
              <div class="row ">
                ...
                <div class="col-md-2 consulor-srt">
                  <label for="">Ward or Village(detail)</label>
              ...
              <div class="row"> <!--service -->
                ...
                <div class="col-md-3 consulor-srt">
                  <label for="">New/Old(Within the Calendar Year)</label>
              ...
              <div class="row hts-entry">
                <div class="col-sm-5 consulor-result"><!--HIV -->
                  <div class="row">
                ...
                <div class="col-sm-4 consulor-result">
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <label>VDRL</label>
                      <input id="syp_vdrl" class="form-control" type="text" name="" value="">
                    </div>
                  </div>
                </div>
                <div class="col-sm-3 consulor-result">
                  <div class="row">
              ...
              <div class='row' >
                <div class="col-sm-1" >
                  <button type="button" id="updateBton" onclick="risk_update()" class="btn btn-warning save-batton ">Save</button>
                </div>
                <div class="col-sm-1" >
                  <button type="button" id="hts_updateBton" onclick="HTS_save()" class="btn btn-warning update-batton ">Update</button>
                </div>
              </div>
              <br>
              <div class="row">
...
function switchToggle() {
  $( ".consulor-result" ).toggle(1000);
  $("#hts_updateBton").toggle(1000);
  $("#updateBton").prop('disabled',true);
}

// $( "#switch_toggle" ).change(function() {
//   console.log ("hello switch"),
//   $( ".hts-entry" ).hide( "slow", function() {
