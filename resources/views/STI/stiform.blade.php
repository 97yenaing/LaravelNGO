...
<body>
  ...
  @endphp <!--onload="findRegisterData()" onlod function change form gender//yenaing -->
  <div class="container containers assist-sti ">
    ...
    <ul class="nav nav-tabs toggle sti-colist" id="hidden-title">
      <li class="nav-item">
        <a class="nav-link active toggle-link"
          data-toggle="pill"
          href="#home">Register</a>
      </li>
      <li class="nav-item">
        <a class="nav-link toggle-link"
          data-toggle="pill"
          onclick=""
          href="#menu1">Physical Exam</a>
      </li>
      <li class="nav-item">
        <a class="nav-link toggle-link"
          data-toggle="pill"
          onclick=""
          href="#menu2">Lab Results & Treatment</a>
      </li>
      <li>
        <a class="nav-link toggle-link"
          data-toggle="pill"
          onclick=""
          href="#menu3">Follow Up History</a>
      </li>
      <li>
        <a class="nav-link toggle-link"
          data-toggle="pill"
          onclick=""
          href="#menu4">RPR Test History</a>
      </li>
      <li>
        <a class="nav-link toggle-link"
          data-toggle="pill"
          onclick=""
          href="#menu5">Search and Update</a>
      </li>
      <li>
        <a class="nav-link toggle-link"
          data-toggle="pill"
    ...
    <div class="tab-content assist-parent-div">
      <div class="tab-pane  active"
        ...
        <div class="row">
          ...
          <div class="col-sm-3"
            ...
            style="display:none">
            <input type="checkbox"
              id="sti_id_change"><label for=""
              style="display: inline-block">General ID Change?</label>
          </div>
        </div>
        <div id="registerForm">
            ...
            <div class="row sti-Id">
              <div class="col-sm-4">
                <label for="validationCustom01"
                  class="form-label">General ID and Registration/Follow-Up Date</label>
                <div class="input-group mb-4">
                  <input type="number"
                    id="pid"
                    class="form-control input-group-append no-margin"
              ...
              <div class="col-sm-2">
                <label for="validationCustom01"
                  class="form-label">Reg_Age/Cur Age</label>
                <span id="current_reg_age"
          ...
          <div class="row sti-firstSecond">
            ...
            <div class="col-sm-3">
              <label for="validationCustom01"
                class="form-label">First Visit</label>
              <select class="form-control"
                id="firstVisit"
                onchange="firstVisit()"
                name="">
            ...
            <div class="col-sm-3">
              <label for="validationCustom01"
                class="form-label">If Last Visit</label>
              <select class="form-control"
                id="lastVisit"
                name="">
                <option value="0"></option>
        ...
        <div class="register-second-section row">
          ...
          <div class="col-sm-6 sti-check hide "
            id="lastVisit_Check">
            <span id="lastVisit_Date"
              class="badge badge-dark"> Check </span>
          </div>
          <div class="row sti-risk">
            <div class="col-sm-3">
              <label for="validationCustom01"
                class="form-label">Episode</label>
            ...
            <div class="col-sm-3">
              <label for="validationCustom01"
                class="form-label">Reasons For Visit</label>
              <select onchange="visit()"
                class="form-select"
                id="reason"
                name="">
                <option value="0"></option>
            ...
            <div class="col-sm-3"
              id="m1">
              <label for="validationCustom01"
                class="form-label">Risk Factor_Male</label>
            ...
            <div id="f1"
              class="col-sm-3">
              <label for="validationCustom01"
                class="form-label">Risk Factor_Female</label>
          ...
          <div>
            <div class="row sti-male sti-registerMale"
              id="sti-maleID"> <!-- male -->
              <h2>Test For Male</h2>
              <div class="col-sm-3" id="m2">
                <label for="validationCustom01"
                  class="form-label">Urethral discharge</label>
                <select class="form-select"
                  id="urethral_discharge"
                  name="">
                  <option value="0"></option>
                  <option value="1">Yes</option>
                  <option value="2">No</option>
              ...
              <div class="col-sm-3"
                id="m3">
                <label for="validationCustom01"
                  class="form-label">How long days</label>
                <input id="howlong_days"
                  type="number"
                  class="form-control"
                  id="validationCustom01">
                <div class="valid-feedback">
              ...
              <div class="row">
                <div class="col-sm-3"
                  id="m4">
                  <label for="validationCustom01"
                    class="form-label">Scrotal Swelling</label>
                  <select id="scrotal_swelling" class="form-select"
                    name="">
                    <option value="0"></option>
                    <option value="1">Yes</option>
                    <option value="2">No</option>
                ...
                <div class="col-sm-3"
                  id="m5">
                  <label for="validationCustom01"
                    class="form-label">How Long</label>
                  <input id="hl_scrotal_swelling"
                    type="text"
                    class="form-control"
                    id="validationCustom01">
                </div>
                <div class="col-sm-3" id="m6">
                  <label for="validationCustom01"
                    class="form-label">Tender/ Non-Tender</label>
                  <select id="tender" class="form-select"
                    name="">
                    <option value="0"></option>
            ...
            <div id="sti-femaleID"
              class="sti-female sti-registerFemale"><!-- femmale div-->
              <h2>Test For female</h2>
              <div class="row"> <!-- femmale -->
                <div class="col-sm-3"
                  id="f2">
                  <label for="validationCustom01"
                    class="form-label">Abnormal vaginal discharge</label>
                  <select class="form-select"
                    id="abVagdischarge">
                    <option value="0"></option>
                    <option value="1">Yes</option>
              ...
              <div class="row"><!-- femmale -->
                <div class="col-sm-3"
                  id="f4">
                  <label for="validationCustom01"
                    class="form-label">Linked with menstruation</label>
                  <select class="form-select"
                    id="Link_menstra">
                    <option value="0"></option>
                    <option value="1">Yes</option>
              ...
              <div class="row"><!-- femmale -->
                <div class="col-sm-3"
                  id="f7">
                  <label for="validationCustom01"
                    class="form-label">Abnormal vaginal odour</label>
                  <select class="form-select"
                    id="odour">
                    <option value="0"></option>
                    <option value="1">Yes</option>
                ...
                <div class="col-sm-3"
                  id="f8">
                  <label for="validationCustom01"
                    class="form-label">Lower abdominal pain </label>
                  <select class="form-select"
                    id="lower_abd_pain">
                    <option value="0"></option>
                    <option value="1">Yes</option>
              ...
              <div class="row"><!-- femmale -->
                ...
                <div class="col-sm-4"
                  id="f11">
                  <label for="validationCustom01"
                    class="form-label">Recent Termination Pregnancy </label>
                  <select class="form-select"
                    id="terminate_preg">
                    <option value="0"></option>
                    <option value="1">Yes</option>
                ...
                <div class="col-sm-2"
                  id="f12">
                  <label for="validationCustom01"
                    class="form-label">Dyspareunia</label>
                  <select class="form-select"
                    id="dyspareunia">
                    <option value="0"></option>
                    <option value="1">Yes</option>
              ...
              <div class="row"><!-- femmale -->
                <div class="col-sm-12"
                  id="f13">
                  <label for="validationCustom01"
                    class="form-label">Other GI Symptoms</label>
                  <input type="text" class="form-control"
                    id="oth_gi_sym" name=""
                    value="0">
                </div>
            ...
            <div class="sti-common sti-registerCommon"
              id="sti-commonID"> <!-- common div -->
              <h2>Test For Any Sex</h2>
              <div class="row"><!-- common -->
                <div class="col-sm-3"
                  id="g1">
                  <label for="validationCustom01"
                    class="form-label">Dysuria</label>
                  <select class="form-select"
                    id="dysuria"
                    name="">
                    <option value="0"></option>
                ...
                <div class="col-sm-3" id="g3">
                  <label for="validationCustom01"
                    class="form-label">Genital Prutitus</label>
                  <select class="form-select"
                    id="genital_prutitus"
                    name="">
                    <option value="0"></option>
                ...
                <div class="col-sm-3" id="g4">
                  <label for="validationCustom01"
                    class="form-label">How long</label>
                  <input id="howlong_genital_pruti"
                    type="number"
                    max="250"
                    class="form-control"
                    id="validationCustom01">
              ...
              <div class="row"><!-- common -->
                <div class="col-sm-4" id="g5">
                  <label for="validationCustom01"
                    class="form-label">Genital burnig or Pain</label>
                  <select class="form-select"
                    id="genital_burn"
                    name="">
                    <option value="0"></option>
              ...
              <div class="row"><!-- common -->
                <div class="col-sm-2" id="g7">
                  <label for="validationCustom01"
                    class="form-label">Genital ulcer</label>
                  <select id="genital_ulcer" class="form-select"
                    name="">
                    <option value="0"></option>
                    <option value="1">Yes</option>
                    <option value="2">No</option>
                ...
                <div class="col-sm-2" id="g8">
                  <label for="validationCustom01"
                    class="form-label">How Long</label>
                  <input id="howlong_genital_ulcer"
                    type="text"
                    class="form-control"
                    id="validationCustom01">
                ...
                <div class="col-sm-2" id="g9">
                  <label for="validationCustom01"
                    class="form-label">Pain</label>
                  <select id="pain" class="form-select"
                    name="">
                    <option value="0"></option>
                ...
                <div class="col-sm-2" id="g10">
                  <label for="validationCustom01"
                    class="form-label">Ulcer</label>
                  <select id="ulcer" class="form-select"
                    name="">
                    <option value="0"></option>
                ...
                <div class="col-sm-4" id="g11">
                  <label for="validationCustom01"
                    class="form-label">Prodormal itch/buring</label>
                  <select id="prodormal_itch" class="form-select"
                    name="">
                    <option value="0"></option>
                    <option value="1">Yes</option>
                    <option value="2">No</option>
                ...
                <div class="col-sm-4" id="g12">
                  <label for="validationCustom01"
                    class="form-label">Started as vesicles /blisters</label>
                  <select id="start_vesicles" class="form-select"
                    name="">
                    <option value="0"></option>
                    <option value="1">Yes</option>
                    <option value="2">No</option>
                ...
                <div class="col-sm-2" id="g13">
                  <label for="validationCustom01"
                    class="form-label">Recurrent</label>
                  <select id="recurrent" class="form-select"
                    name="">
                    <option value="0"></option>
                    <option value="1">Yes</option>
                    <option value="2">No</option>
                ...
                <div class="col-sm-2" id="g14">
                  <label for="validationCustom01"
                    class="form-label">Last Episode</label>
                  <select id="last_episode" class="form-select"
                    name="">
                    <option value="0"></option>
                    <option value="1">Yes</option>
                    <option value="2">No</option>
                ...
                <div class="col-sm-4" id="g15">
                  <label for="validationCustom01"
                    class="form-label">Patient Suspects Herpes</label>
                  <select id="patient_suspect_herpes" class="form-select"
                    name="">
                    <option value="0"></option>
                    <option value="1">Yes</option>
                    <option value="2">No</option>
              ...
              <div class="row"><!-- common -->
                <div class="col-sm-3"
                  id="g16">
                  <label for="validationCustom01"
                    class="form-label">Inguinal lymph node</label>
                  <select id="inguinal_lymph_node" class="form-select"
                    name="">
                    <option value="0"></option>
                    <option value="1">Yes</option>
                    <option value="2">No</option>
                ...
                <div class="col-sm-2"
                  ...
                  <label for="validationCustom01"
                    class="form-label">How Long</label>
                  <input id="hl_inguinal_lymph_node"
                    type="text"
                    class="form-control"
                    id="validationCustom01">
                </div>
                <div class="col-sm-3"
                  id="g18">
                  <label for="validationCustom01"
                    class="form-label">Unilateal/Bilateral</label>
                  <select id="unilateal" class="form-select"
                    name="">
                    <option value="0"></option>
                ...
                <div class="col-sm-4"
                  id="g19">
                  <label for="validationCustom01"
                    class="form-label">Leg ulcer/other infection</label>
                  <select id="leg_ulcer_inf" class="form-select"
                    name="">
                    <option value="0"></option>
                    <option value="1">Yes</option>
                    <option value="2">No</option>
              ...
              <div class="row"><!-- common -->
                <div class="col-sm-3" id="g20">
                  <label for="validationCustom01"
                    class="form-label">Genital Warts</label>
                  <select id="genital_wart" class="form-select"
                    name="">
                    <option value="0"></option>
                    <option value="1">Yes</option>
                    <option value="2">No</option>
      ...
      <div class="tab-pane  fade sti-phySection"
        id="menu1">
        <div class="followup phyExam-section"
          id="followup">
          ...
          <div class="row sti-exam">
            <div class="col-sm-3">
              <label for="validationCustom01"
                class="form-label">Physical Exam</label>
              <select class="form-select"
                id="physical_exam"
                name=""
                onchange="stiPhysical()">
                <option value="0"></option>
                <option value="1">Yes</option>
                <option value="2">No</option>
                <option value="9">Missing</option>
          ...
          <div class="row sti-female sti-phyfemale"
            id="stiPhy-femaleID"><!-- female -->
            <h2>Test For Female</h2>
            <div class="col-sm-3 wash-v3ah"
              id="f15">
              <label for="validationCustom01"
                class="form-label">Washed inside < 1
                  hour
                  </label>
                  <select class="form-select"
                    id="wash_inside"
            ...
            <div class="col-sm-3 wash-v3ah"
              id="f16">
              <label for="validationCustom01"
                class="form-label">Vulvar erythema</label>
              <select class="form-select" id="vulvar_erythema"
                name="">
                <option value="0"></option>
                <option value="1">Yes</option>
                <option value="2">No</option>
            ...
            <div class="col-sm-3 wash-v3ah"
              id="f17">
              <label for="validationCustom01"
                class="form-label">Vulvar odema</label>
              <select class="form-select"
                id="vulvar_odema"
                name="">
                <option value="0"></option>
            ...
            <div class="col-sm-3 wash-v3ah"
              id="f18">
              <label for="validationCustom01"
                class="form-label">Vaginal Discharge</label>
              <select class="form-select"
                id="vag_dis"
                name="">
                <option value="0"></option>
            ...
            <div class="col-sm-3 wash-v3ah"
              id="f20">
              <label for="validationCustom01"
                class="form-label">Homogeneous</label>
              <select class="form-select"
                id="homogeneous"
                name="">
                <option value="0"></option>
            ...
            <div class="col-sm-3 wash-v3ah"
              id="f22">
              <label for="validationCustom01"
                class="form-label">Smell(Without KOH)</label>
              <select class="form-select"
                id="smell_koh"
                name="">
                <option value="0"></option>
            ...
            <div class="row"><!-- female -->
              <div class="col-sm-3"
                id="f23">
                <label for="validationCustom01"
                  class="form-label">Vaginal wall injury</label>
                <select class="form-select"
                  id="phi_vag_wall"
                  name="">
                  <option value="0"></option>
              ...
              <div class="col-sm-3"
                id="f24">
                <label for="validationCustom01"
                  class="form-label">Adnexal tenderness</label>
                <select class="form-select"
                  id="phi_ad_tender"
                  name="">
                  <option value="0"></option>
              ...
              <div class="col-sm-3"
                id="f25">
                <label for="validationCustom01"
                  class="form-label">Adnexal enlargement</label>
                <select class="form-select"
                  id="phi_ad_enlarge"
                  name="">
                  <option value="0"></option>
            ...
            <div class="row"><!-- female -->
              <div class="col-sm-3"
                id="f29">
                <label for="validationCustom01"
                  class="form-label">Genital blisters</label>
                <select id="genital_blisters"
                  class="form-select"
                  name="">
                  <option value="0"></option>
                  <option value="1">Yes</option>
              ...
              <div class="col-sm-9"
                ...
                <Input id="genital_blisters_location"
                  class="form-control">
              </div>
            </div>
            <div class="col-sm-3"
              id="f26">
              <label for="validationCustom01"
                class="form-label">KOH smell test</label>
              <select class="form-select"
                id="phi_koh_smell"
                name="">
                <option value="0"></option>
            ...
            <div class="col-sm-3"
              id="f27">
              <label for="validationCustom01"
                class="form-label">pH Vagina</label>
              <select class="form-select"
                id="phi_ph_vagina"
                name="">
                <option value="0"></option>
            ...
            <div class="col-sm-12"
              id="f28">
              <label for="validationCustom01"
                class="form-label">Make drawing and describe</label>
              <Input class="form-control"
                id="phi_drawing_f"
                name="">
            </div>
          </div>
          <div class="row sti-male sti-phymale"
            id="stiPhy-maleID">
            <h2>Test For Male</h2>
            <div class="col-sm-4 stiPhysical-urinated"
              id="m7">
              <label for="validationCustom01"
                class="form-label">Urinated within < 1
                  hour
                  before
                  visit</label>
                  <select class="form-select"
                    id="urinated_within1hr">
                    <option value="0"></option>
                    <option value="1">Yes</option>
                    <option value="2">No</option>
                    <option value="9">Missing</option>
            ...
            <div class="col-sm-2"
              id="m8">
              <label for="validationCustom01"
                class="form-label">Discharge</label>
              <select class="form-select"
                id="discharge"
                name="">
                <option value="0"></option>
            ...
            <div class="col-sm-3"
              id="m9">
              <label for="validationCustom01"
                class="form-label">Discharge after milking</label>
              <select class="form-select"
                id="discharge_after_milking"
                name="">
                <option value="0"></option>
                <option value="1">Visible</option>
                <option value="2">Not Visible</option>
            ...
            <div class="col-sm-3"
              id="m11">
              <label for="validationCustom01"
                class="form-label">Erythema on glans</label>
              <select class="form-select"
                id="phi_erythema"
                name="">
                <option value="0"></option>
            ...
            <div class="col-sm-3"
              id="m12">
              <label for="validationCustom01"
                class="form-label">Blisters on Penis</label>
              <select class="form-select"
                id="phi_blister_penis"
                name="">
                <option value="0"></option>
                <option value="1">Yes</option>
                <option value="2">No</option>
            ...
            <div class="col-sm-2"
              id="m13">
              <label for="validationCustom01"
                class="form-label">Estimated Size</label>
              <input id="phi_estimated_size"
                class="form-control"
                type="text"
                name=""
                value="0">
            ...
            <div class="col-sm-2"
              id="m18">
              <label for="validationCustom01"
                class="form-label">Erythema</label>
              <select class="form-select"
                id="phi_erythema1"
                name="">
                <option value="0"></option>
            ...
            <div class="col-sm-4"
              id="m19">
              <label for="validationCustom01"
                class="form-label">Make Drawing and describe size</label>
              <select class="form-select"
                id="phi_drawing"
                name="">
                <option value="0"></option>
          ...
          <div class="row sti-common sti-phycommon"
            id="stiPhy-commonID">
            <h2>Test For Any Sex</h2>
            <div class="row">
              <div class="col-sm-3"
              ...
              <div class="col-sm-3"
                id="g23">
                <label for="validationCustom01"
                  class="form-label">Signle/Multiple</label>
                <select class="form-select"
                  id="phi_single_multiple"
                  name="">
                  <option value="0"></option>
                  <option value="1">Single</option>
              ...
              <div class="col-sm-3"
                id="g24">
                <label for="validationCustom01"
                  class="form-label">Painfull/Painless </label>
                <select class="form-select"
                  id="phi_painfull"
                  name="">
                  <option value="0"></option>
              ...
              <div class="col-sm-3"
                id="g25">
                <label for="validationCustom01"
                  class="form-label">Herpes suspected </label>
                <select class="form-select"
                  id="phi_herpes_suspected"
                  name="">
                  <option value="0"></option>
                  <option value="1">Yes</option>
                  <option value="2">No</option>
            ...
            <div class="row stiPhy-anysexSecond">
              <div class="col-sm-3" id="g26">
                <label for="validationCustom01"
                  class="form-label">Inguinal bubo </label>
                <select class="form-select"
                  id="phi_inguinal_bubo"
                  name="">
                  <option value="0"></option>
                  <option value="1">Yes</option>
                  <option value="2">No</option>
              ...
              <div class="col-sm-3" id="g27">
                <label for="validationCustom01"
                  class="form-label">Fluctant </label>
                <select class="form-select"
                  id="phi_fluctant"
                  name="">
                  <option value="0"></option>
              ...
              <div class="col-sm-3" id="g29">
                <label for="validationCustom01"
                  class="form-label">Other Leg infection </label>
                <select class="form-select"
                  id="phi_leg_inf"
                  name="">
                  <option value="0"></option>
            ...
            <div class="row">
              ...
              <div class="col-sm-3" id="g31">
                <label for="validationCustom01"
                  class="form-label">Crab lice</label>
                <select class="form-select"
                  id="phi_crab_lice"
                  name="">
                  <option value="0"></option>
              ...
              <div class="col-sm-3" id="g32">
                <label for="validationCustom01"
                  class="form-label">Scabies</label>
                <select class="form-select"
                  id="phi_scabies"
                  name="">
                  <option value="0"></option>
      ...
      <div class="tab-pane  fade"
        ...
        <div class="LabRT-section">
          <br>
          <div class="sti-female sti-labFemale"
            id="stiLab-femaleID"> <!-- femlae -->
            <h2>Test for Female</h2>
            <div class="row"> <!-- femlae -->
              ...
              <div class="col-sm-6"
                id="f32">
                <label for="validationCustom01"
                  class="form-label">Previous STI<br class="tablet">(compl or confirmed)(2)</label>
                <select class="form-select"
                  id="cal1"
                  name="">
                  <option value="0"></option>
              ...
              <div class="col-sm-6" id="f33">
                <label for="validationCustom01"
                  class="form-label">New partner within<br class="tablet"> past 3 months (2)</label>
                <select class="form-select"
                  id="cal2"
                  name="">
                  <option value="0"></option>
            ...
            <div class="row"> <!-- femlae -->
              <div class="col-sm-6 female-row "
                id="f34">
                <label for="validationCustom01"
                  class="form-label">Patient compl.<br class="tablet">Dysuria or genital ulcer(3)</label>
                <select class="form-select"
                  id="cal3"
                  name="">
                  <option value="0"></option>
              ...
              <div class="col-sm-6"
                id="f35">
                <label for="validationCustom01"
                  class="form-label">Partner compl.<br class="tablet">Genital symptoms (3)</label>
                <select class="form-select"
                  id="cal4"
                  name="">
                  <option value="0"></option>
            ...
            <div class="row"> <!-- femlae -->
              <div class="col-sm-6 female-row "
                id="f36">
                <label for="validationCustom01"
                  class="form-label">Patient compl.<br class="tablet"> Lower abdominal pain (1)</label>
                <select class="form-select"
                  id="cal5"
                  name="">
                  <option value="0"></option>
              ...
              <div class="col-sm-6" id="f37">
                <label for="validationCustom01"
                  class="form-label">Sex worker</label><br class="tablet">
                <select class="form-select"
                  id="cal6"
                  name="">
                  <option value="0"></option>
            ...
            <br>
            <div class="row"> <!-- femlae -->
              <div class="col-sm-3 calculate-score"
                id="f38">
                <button onclick="calSore()"
                  type="button"
                  class="btn btn-dark">Calculate Score</button>
              </div>
              <div class="col-sm-2 calculate-score"
                id="f39">
              ...
              <div class="col-sm-2 calculate-score"
                id="f40">
                <span id="scoreNum"
                  class="badge bg-danger sti-score">-</span>
              </div>
            ...
            <div class="row"> <!-- femlae -->
              <div class="col-sm-12 sti-risk-remark"
                id="f43">
            ...
            <div class="row stiPhy-abomal"> <!-- femlae -->
              <div class="col-sm-6 sti-cervical-infection" id="f45">
                <label for="validationCustom01"
                  class="form-label">Abnormal yellow discharge (if only abnormal<br class='sti-mobile'> abundant discaarge)(2)</label>
                <select class="form-select"
                  id="ab_yellow_discharge"
                  name="">
                  <option value="0"></option>
                  <option value="1">Yes</option>
                  <option value="2">No</option>
              ...
              <div class="col-sm-6" id="f46">
                <label for="validationCustom01"
                  class="form-label">Pain during sexual untercourse (1)</label>
                <select class="form-select"
                  id="cal7"
                  name="">
                  <option value="0"></option>
            ...
            <div class="row "> <!-- femlae -->
              <div class="col-sm-6 sti-cervical-infection" id="f47">
                <label for="validationCustom01"
                  class="form-label">Dysuria<br class="sti-tablet">(1)</label>
                <select class="form-select"
                  id="cal8"
                  name="">
                  <option value="0"></option>
              ...
              <div class="col-sm-6"
                id="f48">
                <label for="validationCustom01"
                  class="form-label">Unprotected sex with new clients<br class="sti-tablet"> (1)</label>
                <select class="form-select"
                  id="cal9"
                  name="">
                  <option value="0"></option>
            ...
            <div class="row "> <!-- femlae -->
              <div class="col-sm-6 sti-cervical-infection" id="f49">
                <label for="validationCustom01"
                  class="form-label">Lower abdominal pain<br class="sti-tablet"> (1)</label>
                <select class="form-select"
                  id="cal10"
                  name="">
                  <option value="0"></option>
              ...
              <div class="col-sm-6"
                id="f50">
                <label for="validationCustom01"
                  class="form-label">Partner discharge/ Ulcer<br class="sti-tablet"> (2)</label>
                <select class="form-select"
                  id="fe_partner_ulcer"
                  name="">
                  <option value="0"></option>
          ...
          <div class="LabTR-patient"> <!-- male -->
            <div class="sti-male sti-labMale"
              id="stiLab-maleID">
              <h2>Test for male</h2>
              ...
              <div class="row">
                <div class="col-sm-6" id="m21">
                  <label for="validationCustom01"
                    class="form-label">Patient's First Visit To Clinic</label>
                  <select class="form-select"
                    id="pt_1st_visit"
                    name="">
                    <option value="0"></option>
                ...
                <div class="col-sm-6" id="m22">
                  <label for="validationCustom01"
                    class="form-label">Patient's episode of discharge since the last visit.</label>
                  <select class="form-select"
                    id="pt_epi_dis_lastvisit"
                    name="">
                    <option value="0"></option>
                    <option value="1">Yes</option>
                    <option value="2">No</option>
              ...
              <div class="row">
                <div class="col-sm-6"
                  id="m23">
                  <label for="validationCustom01"
                    class="form-label">Patient had unproteced sex with new partner.</label>
                  <select class="form-select"
                    id="unprotected_sex"
                    name="">
                    <option value="0"></option>
                ...
                <div class="col-sm-6"
                  id="m24">
                  <label for="validationCustom01"
                    class="form-label">Patient genital sign/symptoms</label>
                  <select class="form-select"
                    id="genital_sign"
                    name="">
                    <option value="0"></option>
                ...
                <div class="row">
                  <div class="col-sm-12" id="g33">
                    <label class="form-label"
                      for="">Presumptive Diagnosis</label>
                    <input class="form-control"
                      type="text"
                      name=""
                      id="presumptive_diag" value="0">
                  </div>
                </div>
                <label for="validationCustom01"
                  ...
                  <div class="ucler-list clearfix">
                    <ul class="clearfix">
                      <li>
                        ...
                        <select id="primary_syphillis_tb" class=""
                          name="">
                      ...
                      <li>
                        ...
                        <select id="secondary_syphillis_tb"
                          class=""
                          name="">
                          <option value="2">No</option>
                          <option value="1">Yes</option>
                      ...
                      <li>
                        ...
                        <select id="genital_herpes3_tb" class=""
                          name="">
                          <option value="2">No</option>
                          <option value="1">Yes</option>
                        </select>
                      ...
                      <li>
                        ...
                        <select id="genital_scabies3_tb" class=""
                          name="">
                          <option value="2">No</option>
                          <option value="1">Yes</option>
                        </select>
                  ...
                  <div class="disharge-list clearfix">
                    <ul class="clearfix">
                      ...
                      <li>
                        ...
                        <select id="non_gono_urethri_tb" class=""
                          name="">
                          <option value="2">No</option>
                          <option value="1">Yes</option>
                        </select>
                      ...
                      <li>
                        ...
                        <select id="genital_candidiosis_tb"
                          class=""
                          name="">
                          <option value="2">No</option>
                          <option value="1">Yes</option>
                      ...
                      <li>
                        ...
                        <select id="baterial_vaginosis_tb" class=""
                          name="">
                          <option value="2">No</option>
                          <option value="1">Yes</option>
                        </select>
                  ...
                  <div class="otherStd-list clearfix">
                    <ul class="clearfix">
                      <li>
                        ...
                        <select id="congenial_syphillis_tb"
                          class=""
                          name="">
                          <option value="2">No</option>
                          <option value="1">Yes</option>
                      ...
                      <li>
                        ...
                        <select id="latent_syphillis_tb" class=""
                          name="">
                          <option value="0"></option>
                          <option id="latent_syphillis_no"
                            value="2">No</option>
                          <option id="latent_syphillis_yes"
                            value="1">Yes</option>
                        </select>
                      ...
                      <li id="f55">
                        ...
                        <select id="non_gono_cervities_tb"
                          class=""
                          name="">
                          <option value="2">No</option>
                          <option value="1">Yes</option>
                      ...
                      <li id="f56">
                        ...
                        <select id="latent_syp_pregancy_tb"
                          class=""
                          name="">
                          <option value="2">No</option>
                          <option value="1">Yes</option>
                      ...
                      <li>
                        ...
                        <select id="molluscum_contagiosum_tb"
                          class=""
                          name="">
                          <option value="2">No</option>
                          <option value="1">Yes</option>
                      ...
                      <li>
                        ...
                        <select id="genital_warts3_tb" class=""
                          name="">
                          <option value="2">No</option>
                          <option value="1">Yes</option>
                        </select>
                  ...
                  <table class="table table-borderless">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <label>Primary Syphillis</label>
                          <select id="primary_syphillis" class=""
                            name="">
                            <option value="2">No</option>
                            <option value="1">Yes</option>
                          </select>
                      ...
                      <tr>
                        ...
                        <td>
                          <label>Non-Gonococcal Urethritis</label>
                          <select id="non_gono_urethri" class=""
                            name="">
                            <option value="2">No</option>
                            <option value="1">Yes</option>
                          </select>
                        ...
                        <td>
                          <label>Latent Syphillis</label>
                          <select id="latent_syphillis" class=""
                            name="">
                            <option value="0"></option>
                            <option id="latent_syphillis_no"
                              value="2">No</option>
                      ...
                      <tr>
                        ...
                        <td>
                          <label>Molluscum Contagiosum</label>
                          <select id="molluscum_contagiosum"
                            class=""
                            name="">
                            <option value="2">No</option>
                            <option value="1">Yes</option>
                      ...
                      <tr>
                        <td>
                          <label>Genital Herpes</label>
                          <select id="genital_herpes3" class=""
                            name="">
                            <option value="2">No</option>
                            <option value="1">Yes</option>
                          </select>
                      ...
                      <tr>
                        <td>
                          <label>Genital Scabies</label>
                          <select id="genital_scabies3" class=""
                            name="">
                            <option value="2">No</option>
                            <option value="1">Yes</option>
                          </select>
                        ...
                        <td>
                          <label> Genital Warts</label>
                          <select id="genital_warts3" class=""
                            name="">
                            <option value="2">No</option>
                            <option value="1">Yes</option>
                          </select>
                      ...
                      <tr>
                        ...
                        <td>
                          <label>Baterial Vaginosis</label>
                          <select id="baterial_vaginosis" class=""
                            name="">
                            <option value="2">No</option>
                            <option value="1">Yes</option>
                          </select>
            ...
            <div class="row">
              <div class="LabRDT-treatment-checkbox">
                <div class="col-sm-3">
                  <input type="checkbox"
                    id="tre_azythro"
                    name=""><label>1.</label><label> Azythro</label>
                </div>
                <div class="col-sm-3">
                  <input type="checkbox"
                    id="tre_cefixim"><label>2.</label><label> Cefixim</label>
                </div>
                <div class="col-sm-3">
                  <input type="checkbox"
                    id="tre_ciprofloxacin"><label>3.</label><label> Ciprofloxacin</label>
                </div>
                <div class="col-sm-3">
                  <input type="checkbox"
                    id="tre_tinidazole"><label>4.</label><label> Tinidazole</label>
                </div>

                <div class="col-sm-3">
                  <input type="checkbox"
                    id="tre_fluconazole"><label>5.</label><label> Fluconazole</label>
                </div>
                <div class="col-sm-3">
                  <input type="checkbox"
                    id="tre_doxycycline"><label>6.</label><label> Doxycycline</label>
                </div>
                <div class="col-sm-3">
                  <input type="checkbox"
                    id="tre_ceftriaxone"><label>7.</label><label> Ceftriaxone</label>
                </div>
                <div class="col-sm-3">
                  <input type="checkbox"
                    id="tre_benzpen"><label>8.</label><label> Benz Pen</label>
                </div>

                <div class="col-sm-3"
                  id="f52">
                  <input type="checkbox"
                    id="clotrimazole"><label>9.</label><label> Clotrimazole vaginal tab</label>
                </div>
                <div class="col-sm-3"
                  id="m26">
                  <input type="checkbox"
                    id="no_treament1"><label>10.</label><label> No Treatment</label>
                </div>
                <div class="col-sm-3"
                  id="f53">
                  <input type="checkbox"
                    id="no_treament"><label>10.</label> <label>No Treatment</label>
                </div>
              ...
              <div class="LabRDT-treatment-allergy">
                <div class="row">
                  <div class="col-sm-3">
                    <label for="validationCustom01"
                      class="form-label">Penicillin Allergy</label>
                    <select class="form-select"
                      id="allergy"
                      name="">
                      <option value="0"></option>
                  ...
                  <div class="col-sm-3">
                    <label for="validationCustom01"
                      class="form-label">Sulfa Allergy</label>
                    <select class="form-select"
                      id="sulfa"
                      name="">
                      <option value="0"></option>
                  ...
                  <div class="col-sm-3">
                    <label for="validationCustom01"
                      class="form-label">Partner Treatment Given</label>
                    <select class="form-select"
                      id="parter_treatment_given"
                      name="">
                      <option value="0"></option>
                      <option value="1">Yes</option>
                      <option value="2">No</option>
                  ...
                  <div class="col-sm-3">
                    <label for="validationCustom01"
                      class="form-label">Condom given</label>
                    <select class="form-select"
                      id="condom"
                      name="">
                      <option value="0"></option>
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <label class="form-label"
                      for="">Remark for Treatment</label>
                    <input class="form-control"
                      type="text"
                      id="remarkTreatment"
                      value="0">
            ...
            <div class="row sti-button"> <!-- Buttons -->
              <div class="col-sm-3 show-button"
                id=save-male>
                <button id="male_btn"
                  onclick="sendDataMale(this)"
                  class="btn btn-warning btn-block save-batton">Save(Male)</button>
              </div>
              <div class="col-sm-3 show-button"
                id=update-male>
                <button id="maleUpdate_btn"
                  onclick="Sti_Male_Updater(updateResp_M)"
                  class="btn btn-success btn-block update-batton">Update STI (Male)</button>
              </div>
              <div class="col-sm-3 show-button"
                id=save-female>
                <button id="female_btn"
                  onclick="sendDataFemale(this)"
                  class="btn btn-warning btn-block save-batton">Save(Female)</button>
              </div>
              <div class="col-sm-3 show-button"
                id=update-female>
                <button id="femaleUpdate_btn"
                  onclick="Sti_Female_Updater(updateResp_F)"
                  class="btn btn-success btn-block update-batton">Update STI (Female)</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="tab-pane assist-history fade"
        id="menu3">
        <div class="row ">
      ...
      <div class="tab-pane assist-history fade"
        ...
        <div class="row">
          ...
          <div class="col-sm-3">
            ...
            <button id="pid_shar"
              onclick="findRegDataUpdate()"
              class="form-control btn btn-warning update-batton general-id"> Search ID</button>
          </div>
        </div>
        <div class="row"
          style="margin:auto;">
...
<script type="text/javascript"
  ...
  var female = ['f1', 'f2', 'f3', 'f4', 'f5', 'f6', 'f7', 'f8', 'f9', 'f10',
  ...
  var male = ['m1', 'm2', 'm3', 'm4', 'm5', 'm6', 'm7', 'm8', 'm9', 'm10',
  ...
  var fill_id;
  let riskCal = "";
  var updateResp_F = UpDel_Date = "";
  //console.log(@json($mam_clinicID));
  ...
  function findRegisterData() {
    ...
    var sti_vdate = formatDate($("#regdate").val());
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          if (response.length > 2) {
            ...
            var r0 = Object.keys(response[0]).length; //patients
            ...
            if (countResponse > 0) {
              ...
              if (r0 > 0) { /////////////////////////////////////////////////////// ====>>>>>>>>>>>>>>> Need to change "r0"
                ...
                $("#current_reg_age").text(response[0]["Agey"] + "/" + response[0]["Current Agey"]);
                agesti = response[0]["Agey"];
                document.getElementById('pid').innerHTML = response[0]["CID"];
                document.getElementById('fuchia').value = response[0]["FuchiaID"];
                ...
                if (gender_changer == "Male") {
                  ...
                  if ($("#sti_id_change").prop("checked") == true) {
          ...
          if (countResponse > 0) {
            ...
            if (r1 > 0) { // Male
              ...
              for (var male_row = 0; male_row < r1; male_row++) {
                var maleIDcount = 0;
                var but_ton0 = "<button onclick='stiupdated()' class='sti-update-button btn btn-warning' id=sti_maleUp_" + response[1][male_row]['id'] + ">" + "GO-Updated" + "</button>" +
                  "<button onclick='stiremove(this)' class='sti-removeBtn-male btn btn-danger'id=sti_maleDel_" + response[1][male_row]['id'] + ">" + "Delete Row" + "</button>";
                var result_body0 = "<tr style='background-color:#69D2E7;' id=updateSerial_male" + male_row + maleIDcount + ">" +
                  "<td>" + (male_row + 1) + "</td>" + "</td>" + "<td >" + response[1][male_row]['Visit_date'] + "</td>" +
            ...
            if (r2 > 0) { //Female
              ...
              for (var female_row = 0; female_row < r2; female_row++) {
                var femaleIDcount = 0;
                var but_ton0 = "<button onclick='stiupdated()' class='sti-update-button btn btn-warning' id=sti_femaleUp_" + response[2][female_row]['id'] + ">" + "GO-Updated" + "</button>" +
                  "<button onclick='stiremove(this)' class='sti-removeBtn-male btn btn-danger'id=sti_femaleDel_" + response[2][female_row]['id'] + ">" + "Delete Row" + "</button>";

                var result_body0 = "<tr style='background-color:#69D2E7;'id=updateSerial_female" + female_row + femaleIDcount + ">" +
                  "</td>" + "<td>" + (female_row + 1) + "</td>" + "<td >" + response[2][female_row]['Visit_date'] + "</td>" +
  ...
  function sendDataMale(button) {
    var sti_male = 1;
    //first page
    var pid = document.getElementById("pid").value;
    //var clinic = document.getElementById("clinic").innerHTML);
    var clinic = document.getElementById("clinic_code").value;
    ...
    console.log()
    if (regdate.length > 5 && pid.length > 9 && pid.length < 13) {
      ...
      alert("Please check General ID and Date");
      //location.reload(true);
  ...
  function sendDataFemale(button) {
    let sti_female = 1;
    //first page
    ...
    let fe_clinic = document.getElementById("clinic_code").value;
    ...
    console.log(fe_regdate.length, fe_pid.length)
    if (fe_regdate.length > 5 && fe_pid.length > 9 && fe_pid.length < 13) {
  ...
  // Male Section
  function stiupdated() {
    var updated_rowID = event.target.id.match(/\d+/)[0];
    console.log(updated_rowID);
    $(".sti-colist li:nth-child(6) a,.assist-parent-div #menu5").removeClass('active');
    $(".sti-colist li:first-child a,.assist-parent-div #home").addClass('active');
    ...
    $("#home select,#menu1 select,#menu2 select").css({
      "color": "#f469a9",
      "font-weight": "bold"
    })
    $("#home span,#home input,#menu1 span,#menu1 input,#menu2 span,#menu2 input").css({
      "color": "#f469a9",
      "font-weight": "bold"
    });
    var updated_dataSti = {
      ...
      sti_Updated_fill: "sti_fill_data",
    ...
    $.ajax({
      ...
      success: function(response) {
        console.log(response);
        $("#pid,#regdate").prop("disabled", true);
        $("#idchange_section").show();
        if (updatedsex == "male") {
  ...
  function stiremove(button) {
    var remove_date = formatDate($(event.target).parent().parent().children().eq(1).text());
    console.log(remove_date);
    var remvoe_rowID = event.target.id.match(/\d+/)[0];
    var remove_dataSti = {
      remove_date: remove_date,
      remove_id: fill_id, // CID or PID
      remvoe_rowID: remvoe_rowID, // DB primary key 
      removesex: updatedsex,
      notice: "sti_remove_data",

    };
    console.log(remove_dataSti);
    if (confirm("Are you sure you wanna delete this STI data")) {
      ...
      $.ajax({
        ...
        dataType: 'json',
        contentType: 'application/json',
        data: JSON.stringify(remove_dataSti),
        beforeSend: function() {
          $(button).prop("disabled", true);
          timeoutHandle = setTimeout(oneClick, 3000);
        },
  ...
  function StiFiller_Male(resp) {
    ...
    if (male_length > 0) {
      ...
      for (var i = 0; i < sti_maleFill_span.length; i++) {
        document.getElementById(sti_maleFill_span[i]).innerHTML = general_object[sti_maleFill_span[(i + 1)]];
      ...
      $("#idchange_section input:checkbox").prop("checked", false)
  ...
  function Sti_Male_Updater(updateResp_M) {
    ...
    var d_to_ck = fill_toJson["regdate"];
    var d_to_id = fill_toJson["pid"];



    if (d_to_ck.length > 5 && d_to_id.length > 9 && d_to_id.length < 13) {
  ...
  function Sti_Female_Updater(updateResp_F) {
    ...
    var d_to_ck = fill_toJson_female["regdate"];
    var d_to_id = fill_toJson_female["pid"];
    console.log(d_to_ck, d_to_id);
    if (d_to_ck.length > 5 && d_to_id.length > 9 && d_to_id.length < 13) {
      $.ajaxSetup({
        headers: {
          'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
  ...
  function firstVisit() {
    var fvisit = $("#firstVisit").val();
    if (fvisit == '1') {
      $("#lastVisit").prop("disabled", true);
    } else {
      $("#lastVisit").prop("disabled", false);
    }
  }
</script>