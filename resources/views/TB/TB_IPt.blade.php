...
<div class="container containers">
  ...
  <div class="tab-content tb-parent-div">
    <div class="tab-pane active Tb-IPTSection"
      id="Tb_IPT">
      <div id="ipt_mainData">
        <div class="header-text ipt-header"
          id="ipt_header">
          <h2>
            New TB IPT Section
            <button class="btn refresh-follow"
              id="ipt_refresh"
              style="float: right">Refresh</button>
          </h2>
          <button class="btn btn-info ipt-historyBtn"
            id="ipt_history"
            type="button">History</button>

          <label class="from-label history-alert"
            id="ipt_historyAlert"></label>
              ...
              <div class="input-group mb-3 tbIPt-generalCode">
                ...
                <div class="input-group-append no-margin">
                  <button class="btn btn-primary"
                    onclick="findIpt_patient()"
                    type="button">Search</button>
                </div>
              </div>
            </div>
            <div class="col-sm-2 tab30">
        ...
        <div class="ipt_data">
          <div class="row">
            <div class="col-sm-2 ipt-counsellor tab35">
              <label for="validationCustom01"
                class="form-label">Name of Counsellor</label>
            ...
            <div class="col-sm-2 tab30">
              <label for="validationCustom01"
                class="form-label">IPT Register date</label>
        ...
        <div class="ipt_btn">
          <div class="row">
            <div class="col-sm-3">
              <button class="btn btn-success ipt_save"
                onclick="ipt_SaveUp(this)"
                id="iptsaveUp"
                disabled="true">Save
                Record</button>
            </div>
      ...
      <div class="ipt-historyshow"
        id="ipt_historyShow">
        <div class="header-text ipt_historyHead">
          <h3>IPT Records</h3>
        </div>
        <div class="ipt-followList"
          id="ipt_followList">
        ...
        <div style="text-align:center"><button class="btn iptHis-cancel"
            id="iptHis-cancel">Cancel</button></div>
