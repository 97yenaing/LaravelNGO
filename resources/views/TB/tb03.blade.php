...
<div class="container containers">
	<ul class="nav nav-tabs toggle" id="">
		<li class="nav-item">
			<a class="nav-link active toggle-link" data-toggle="pill" href="#Tb_registerForm">Tb_Register_03</a>
		</li>
		...
		<li class="nav-item">
			<a class="nav-link  toggle-link" data-toggle="pill" href="#tb_report">Report</a>
		</li>
	</ul>
	<div class="tab-content tb-parent-div">
		<div class="tab-pane tb-register03 active" id="Tb_registerForm">
			<div id="tb03_main">
				<div style="position: relative">
					<h2 class="header-text">
						TB Register_03
					</h2>
					<button class="btn btn-info tb03-history" id="tb03-history" onclick="view_history()">Follow Up</button>
					<label for="" id="count_follw" class="form-label count-follow"></label>
					<button class="btn refresh-follow tb03-refresh" id="tbo3_refresh" style="float:right">Refresh</button>
				</div>
				<div id="Tb_generalData">
					<div class="row">
						<div class="col-sm-2 TB-idChange" id="ID_changeBlock">
							<input type="checkbox" id="TBid_change" disabled="true">
							<label class="form-label">ID change?</label>
						</div>
						<div class="col-sm-3 TB-idChange" id="new_RC_Block">
							<input type="checkbox" id="TBexit_newRec" onclick="same_ID_newRc()">
					...
					<div class="row">
						<div class="col-sm-5">
							<div class="input-group mb-3 tb-generalCode">
								<input type="number" id="TB03_pid" class="form-control" placeholder="General ID">
								<input type="text" id="TB03_fuchiaId" class="form-control" placeholder="Fuchia ID">
								<input type="text" id="TB03_id" class="form-control" placeholder="Township TB Reg Number">
								<button class="btn btn-primary" onclick="findTB03_patient()" type="button">Search</button>
							</div>
						</div>
						<div class="col-sm-2">
							<label for="validationCustom01" class="form-label">Register Age</label>
							<span id="TB03_age" type="number" class="form-control"></span>
						</div>
						<div class="col-sm-1">
							<label for="validationCustom01" class="form-label">Sex</label>
							<span id="TB03_gender" class="form-control"></span>
						</div>
						<div class="col-sm-2 tb-region">
							<label for="validationCustom02" class="form-label">State/ Region</label>
							<span class="form-control" id="TB03_state"></span>
						</div>
						<div class="col-sm-2 tb-township">
							<label for="validationCustom02" class="form-label">Township</label>
							<span class="form-control" id="TB03_town"></span>
						</div>
					</div>
				</div>
				<div id="tb_info">
					...
					<div class="row">
						<div class="col-sm-2">
							<label for="validationCustom01" class="form-label">Treatment Date</label>
							<div class="date-holder">
								<input type="text" class="form-control Gdate" id="TB03_tremDate" placeholder="dd-mm-yyyy">
								<img src="../img/calendar3.svg" class="dateimg" alt="date">
							</div>
						</div>
						<div class="col-sm-2">
							<label for="validationCustom01" class="form-label">Nationality</label>
							<select class="form-control" id="TB03_nationality" name="">
								<option value=""></option>
						...
						<div class="col-sm-4">
							<label for="validationCustom01" class="form-label">Facility name</label>
							<select class="form-control" id="TB03_facility" name="">
								<option value="-"></option>
						...
						<div class="col-sm-2">
							<label for="validationCustom01" class="form-label">Reporting Period</label>
							<select class="form-control" id="TB03_reportPeriod" name="">
								<option value=""></option>
						...
						<div class="col-sm-2">
							<label for="validationCustom01" class="form-label">Transfer in</label>
							<select class="form-control" id="TB03_transfer" name="">
								<option value=""></option>
					...
					<div class="row" id="TB03_locate">
						<div class="col-sm-2">
							<label for="validationCustom01" class="form-label">Refer From</label>
							<select class="form-control" id="TB03_referFrom" name="">
								<option value="-"></option>
						...
						<div class="col-sm-2">
							<label for="validationCustom01" class="form-label">Type of Patient's</label>
							<select class="form-control" id="TB03_typePatient" name="">
								<option value=""></option>
								<option value="N">N</option>
						...
						<div class="col-sm-2">
							<label for="validationCustom01" class="form-label">TB Site</label>
							<select class="form-control" id="TB03_site" name="">
								<option value=""></option>
						...
						<div class="col-sm-2">
							<label for="validationCustom01" class="form-label">Treatment Regimens</label>
							<select class="form-control" id="TB03_treRegimens" name="">
								<option value=""></option>
						...
						<div class="col-sm-2">
							<label for="validationCustom01" class="form-label">Smoking Status</label>
							<select class="form-control" id="TB03_smoke" name="">
								<option value=""></option>
								<option value="C">C</option>
								<option value="P">P</option>
								<option value="N">N</option>
						...
						<div class="col-sm-2">
							<label for="validationCustom01" class="form-label">DM Status</label>
							<select class="form-control" id="TB03_dm" name="">
								<option value=""></option>
								<option value="Y">Yes</option>
								<option value="N">No</option>
								<option value="U">Unkonw</option>
							</select>
						</div>
						<div class="col-sm-12">
							<label for="validationCustom01" class="form-label">Specify _(if EP)/Site of EPTB</label>
							<input id="TB03_EPTB" type="text" class="form-control">
						</div>
					</div>
					<div class="row tb_essential" id="TB03_essentialData">
						<div class="row tb_hivActivites">
							<h3 class="header-text">TB/HIV Activites</h3>

							<div class="col-sm-2">
								<label for="validationCustom01" class="form-label">HIV Status</label>
								<select class="form-control" id="TB03_hiv" name="">
									<option value=""></option>
							...
							<div class="col-sm-3">
								<label for="validationCustom01" class="form-label">ART Start Date</label>
								<div class="date-holder">
									<input type="text" class="form-control Gdate" id="TB03_ART" placeholder="dd-mm-yyyy">
									<img src="../img/calendar3.svg" class="dateimg" alt="date">
								</div>
							</div>
							<div class="col-sm-3">
								<label for="validationCustom01" class="form-label">CPT Start Date</label>
								<div class="date-holder">
									<input type="text" class="form-control Gdate" id="TB03_CPT" placeholder="dd-mm-yyyy">
									<img src="../img/calendar3.svg" class="dateimg" alt="date">
								</div>
							</div>
						</div>
					...
					<div class="row tb_sartDiag">
						...
						<div class="col-sm-3">
							<label for="validationCustom01" class="form-label">Microscope Result</label>
							<select class="form-control" id="TB03_microscope" name="">
								<option value=""></option>
								<option value="P">Positive</option>
								<option value="N">Negative</option>
								<option value="U">Unkonw</option>
						...
						<div class="col-sm-3">
							<label for="validationCustom01" class="form-label">XRay Result</label>
							<select class="form-control" id="TB03_Xray" name="">
								<option value=""></option>
						...
						<div class="col-sm-3">
							<label for="validationCustom01" class="form-label">Xpert Result</label>
							<select class="form-control" id="TB03_Xpert" name="">
								<option value=""></option>
								<option value="N">N</option>
								<option value="I">I</option>
						...
						<div class="col-sm-3">
							<label for="validationCustom01" class="form-label">Culture Result</label>
							<select class="form-control" id="TB03_culture" name="">
								<option value=""></option>
								<option value="N">N</option>
						...
						<div class="col-sm-3">
							<label for="validationCustom01" class="form-label">Counsellor Name</label>
							<select class="form-select" id="TB03_counselor" required="">
								<option value=""></option>
						...
						<div class="col-sm-3">
							<label for="validationCustom01" class="form-label">bacteriological/clinical</label>
							<input id="TB03_bactlogical" type="text" class="form-control">
						</div>
					</div>

					<div class="row" id="tb_time">
						<div class="row">
							<div class="col-sm-2">
								<button class="tb-time-Tab" id="tb-m2">Month 2</button>
							</div>
							<div class="col-sm-2">
								<button class="tb-time-Tab" id="tb-m3">Month 3</button>
							</div>
							<div class="col-sm-2">
								<button class="tb-time-Tab" id="tb-m5">Month 5</button>
							</div>
							<div class="col-sm-2">
								<button class="tb-time-Tab" id="tb-endDiag">End Treatment</button>
							</div>
						</div>
						<div class="col-md-6 tb-m2">
							<div class="row ">
								...
								<div class="col-sm-4">
									<label for="validationCustom01" class="form-label">Microscope</label>
									<select class="form-control" id="TB03_2ndmicroscope" name="">
										<option value=""></option>
										<option value="P">Positive</option>
										<option value="N">Negative</option>
										<option value="U">Unkonw</option>
								...
								<div class="col-sm-4">
									<label for="validationCustom01" class="form-label">Xpert</label>
									<select class="form-control" id="TB03_2ndXpert" name="">
										<option value=""></option>
										<option value="N">N</option>
										<option value="I">I</option>
										<option value="T">T</option>
								...
								<div class="col-sm-4">
									<label for="validationCustom01" class="form-label">Culture</label>
									<select class="form-control" id="TB03_culture_m2" name="">
										<option value=""></option>
										<option value="N">N</option>
										<option value="S">S</option>
										<option value="P">P</option>
						...
						<div class="col-md-6 tb-m3">
							...
							<div class="row">
								<div class="col-sm-4">
									<label for="validationCustom01" class="form-label">Microscope</label>
									<select class="form-control" id="TB03_3rdmicroscope" name="">
										<option value=""></option>
										<option value="P">Positive</option>
										<option value="N">Negative</option>
										<option value="U">Unkonw</option>
								...
								<div class="col-sm-4">
									<label for="validationCustom01" class="form-label">Xpert</label>
									<select class="form-control" id="TB03_3rdXpert" name="">
										<option value=""></option>
										<option value="N">N</option>
										<option value="I">I</option>
										<option value="T">T</option>
								...
								<div class="col-sm-4">
									<label for="validationCustom01" class="form-label">Culture</label>
									<select class="form-control" id="TB03_culture_m3" name="">
										<option value=""></option>
										<option value="N">N</option>
										<option value="S">S</option>
										<option value="P">P</option>
						...
						<div class="col-md-6 tb-m5">
							...
							<div class="row">
								<div class="col-sm-4">
									<label for="validationCustom01" class="form-label">Microscope</label>
									<select class="form-control" id="TB03_5thmicroscope" name="">
										<option value=""></option>
										<option value="P">Positive</option>
										<option value="N">Negative</option>
										<option value="U">Unkonw</option>
								...
								<div class="col-sm-4">
									<label for="validationCustom01" class="form-label">Xpert</label>
									<select class="form-control" id="TB03_5thXpert" name="">
										<option value=""></option>
										<option value="N">N</option>
										<option value="I">I</option>
										<option value="T">T</option>
								...
								<div class="col-sm-4">
									<label for="validationCustom01" class="form-label">Culture</label>
									<select class="form-control" id="TB03_culture_m5" name="">
										<option value=""></option>
										<option value="N">N</option>
										<option value="S">S</option>
										<option value="P">P</option>
						...
						<div class="col-md-6 tb-endDiag">
							...
							<div class="row">
								<div class="col-sm-4">
									<label for="validationCustom01" class="form-label"> Microscope</label>
									<select class="form-control" id="TB03_endmicroscope" name="">
										<option value=""></option>
										<option value="P">Positive</option>
										<option value="N">Negative</option>
										<option value="U">Unkonw</option>
								...
								<div class="col-sm-4">
									<label for="validationCustom01" class="form-label">XRay</label>
									<select class="form-control" id="TB03_endXray" name="">
										<option value=""></option>
										<option value="N">Normal</option>
										<option value="A">Active TB</option>
										<option value="O">Abnormal Other > TB</option>
								...
								<div class="col-sm-4">
									<label for="validationCustom01" class="form-label">Xpert</label>
									<select class="form-control" id="TB03_endXpert" name="">
										<option value=""></option>
										<option value="N">N</option>
										<option value="I">I</option>
										<option value="T">T</option>
						...
						<div class="col-sm-2">
							<label for="" class="form-label">1st line DST</label>
							<select name="" id="1st_dst" class="form-select">
								<option value=""></option>
								<option value="R">R</option>
								<option value="S">S</option>
								<option value="C">C</option>
						...
						<div class="col-sm-2">
							...
							<select class="form-control" id="TB03_outcome" name="">
								<option value=""></option>
								<option value="C">C</option>
						...
						<div class="col-sm-3">
							<label for="validationCustom01" class="form-label">Initial Regimen Started Date</label>
							<div class="date-holder">
								<input type="text" class="form-control Gdate" id="TB03_IRSD" placeholder="dd-mm-yyyy">
								<img src="../img/calendar3.svg" class="dateimg" alt="date">
							</div>
						</div>
						<div class="col-sm-2">
							<label for="validationCustom01" class="form-label">Outcome Date</label>
							<div class="date-holder">
								<input type="text" class="form-control Gdate" id="TB03_outDate" placeholder="dd-mm-yyyy">
								<img src="../img/calendar3.svg" class="dateimg" alt="date">
							</div>
						</div>

						<div class="col-sm-3">
							<label for="validationCustom01" class="form-label">Estimated Outcome Date</label>
							<div class="date-holder">
								<input type="text" class="form-control Gdate" id="TB03_EoutDate" placeholder="dd-mm-yyyy">
								<img src="../img/calendar3.svg" class="dateimg" alt="date">
							</div>
						</div>
						<div class="col-sm-12">
							<label for="validationCustom01" class="form-label">Remark</label>
							<input id="TB03_remark" type="text" class="form-control">
						</div>
					...
					<div class="row" style="justify-content:center">
						<div class="col-sm-2">
							<button class="btn btn-info TB-button" onclick="TB03_saveUp()" disabled="true">Register-TB-03</button>
						</div>
					</div>
				</div>

			</div>
			<div id="tb03_history" style="display: none">
				<table class="table  table-bordered">
					<thead>
						<tr>
							...
							<th>Out Come Date</th>
							<th><button class="btn btn-info" id="TB03_retrun">Main page</button></th>
						</tr>
					</thead>
					<tbody></tbody>
				</table>
		...
		<div class="tab-pane fade" id="tb_report">
			...
			<form action="{{ route('tb03_data') }}" method="POST">
				@csrf
				<div class="row export-div">
					<div class="col-sm-2">
						<label class="form-label">Select Report Type</label>
						<select class="form-select tb-03-report" name="TB_03_report">
					...
					<div class="col-sm-2">
						...
						<div class="date-holder">
							<input type="text" class="form-control Gdate" name="dateFrom" id="tb_exportStart"
					...
					<div class="col-sm-2">
						<select class="form-select TB-03-report-type" name="TB_03_report_type">
							<option value=""></option>
					...
					<div class="col-sm-1" style="display:none">
						<input value="TB 03 Report" name="notice">
					</div>
			...
			<form action="" method="post">
				...
				<div class="row export-div">
					<div class="col-sm-2">
						<label class="form-label">form</label>
						<div class="date-holder">
							<input type="text" class="form-control Gdate" id="tb_03_exportFrom" name="dateFrom"
								placeholder="dd-mm-yyyy">
							<img src="../img/calendar3.svg" class="dateimg" alt="date">
						</div>
					</div>
					<div class="col-sm-2">
						<label class="form-label">To</label>
						<div class="date-holder">
							<input type="text" class="form-control Gdate" id="tb_03_exportTo" name="dateTo" placeholder="dd-mm-yyyy">
							<img src="../img/calendar3.svg" class="dateimg" alt="date">
						</div>
					</div>
					<div class="col-sm-2">
					...
					<div class="col-sm-1" style="display:none">
						<input value="TB 03 Export" name="notice">
					</div>
				</div>
			</form>
		</div>
...
<script type="text/javascript">
	// count input 41
let clinic_Code="";let tB03_UP="",updateRid,TB03_hisData;
var Tbexit_id=[
...
function TB03_saveUp(){
    let TB03_data={},TB_03Exist="";
