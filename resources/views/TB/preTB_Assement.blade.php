  ...
  @auth
    ...
    <div class="container containers">
      <ul class="nav nav-tabs toggle"id="">
        <li class="nav-item">
          <a class="nav-link active toggle-link"
            data-toggle="pill"
            href="#preTbAssment">Pre-TB Assement</a>
        </li>
        <li class="nav-item">
      ...
      <div class="tab-content tb-parent-div">
        <div class="tab-pane active preTbSection"
          id="preTbAssment">
          <div class="preTB-follow"
            id="preTB_Fsection">
            <div class="row">
              <h2>PreTB Follow Histroy</h2>

            </div>
            <div class="row FpreTB-coheader">
              <div class="col-sm-1">No.</div>
              <div class="col-sm-4">General Id</div>
              <div class="col-sm-4">Screening Date</div>
              <div class="col-sm-3">
                <button class="btn btn-info"
                  id="main_page_return">Main Page</button>
              </div>
            </div>
          </div>
          <div class="preFollow-button">
            <button class="btn"
              id="preTB_history">PreTB-History</button>
          </div>
          <div class="IDchange-comfirm">
            ...
            <div class="row idchange-Btnrow">
              <div class="col-sm-2 pretb-Idchange">
                <button class="btn IDchange-yesBtn "
                  id="preTB_idYes">Yes</button>
              </div>
              <div class="col-sm-2 pretb-Idchange">
                <button class="btn IDchange-noBtn "
                  id="preTB_idNo">No</button>
              </div>
            </div>
          ...
          <div class="preTB_Entry">
            <div class="header-text">
              ...
              <div class="preTB-refresh"> <button class="btn refresh-follow "
                  id="preTB_refresh">Refresh</button></div>
            </div>
            <div class="part-section">
              ...
              <div class="row">
                <div class="col-sm-4 preTB-search">
                  <div class="input-group">
                    ...
                    <input id="preTb_fuchiaID"
                      class="form-control"
                      placeholder="Fuchia ID">
                    <button class="btn btn-primary"
                      type="button"
                      onclick="preTB_search()">Search</button>
                  </div>
                </div>
                <div class="col-sm-2">
              ...
              <div class="subTb-section">
                ...
                <div class="col-sm-1 kap-block">
                  ...
                  <div class="col-sm-3">
                    <label for="validationCustom01"
                      class="form-label">Date of TB Screening</label>
                    <div class="date-holder">
                      <input type="text"
                        class="form-control Gdate"
                        id="preTb_nextScreenDate"
                        placeholder="dd-mm-yyyy">
                      <img src="../img/calendar3.svg"
                        class="dateimg"
                        alt="date">
                  ...
                  <div class="col-sm-3">
                    <label for="validationCustom01"
                      class="form-label">Date of Next Visit</label>
                    <div class="date-holder">
                      <input type="text"
                        class="form-control Gdate"
                        id="preTb_nextVDate"
              ...
              <div class="subTb-section preTB-BioRes">
                <div class="subTb-header">
                  <h3>Biological Result</h3>
                </div>
                <div class="row">
                  <div class="col-sm-6 preTb-HTC-block">
                    <input type="checkbox"
                      id="htcpre_check"
                      name=""><label class="preTB_bioChecklabel">HTC</label>
                  ...
                  <div class="col-sm-6 preTb-AFB-block">
                    <input type="checkbox"
                      id="afbpreTb_check"
                      name=""><label class="preTB_bioChecklabel">Sputum AFB</label>
                  ...
                  <div class="col-sm-6 preTb-Genex-block">
                    <input type="checkbox"
                      id="genexTb_check"
                      name=""><label class="preTB_bioChecklabel">GenXpert</label>
                  ...
                  <div class="col-sm-6 preTb-CXR-block">
                    <input type="checkbox"
                      id="cxrTb_check"
                      name=""><label class="preTB_bioChecklabel">CXR</label>
              ...
              <div class="subTb-section tb-CXRreading">
                <div class="subTb-header ">
                  <h3>CXR reading by MDs (prior radiologist)</h3>
                </div>
                ...
                <div class="row"
                  ...
                  <div class="col-sm-3 CXR-dataCheck">
                    <input type="checkbox"
                      id="susAct_onpreTb"
                      name=""><label>Suspicoin on Active TB</label>
                  </div>
                  <div class="col-sm-3 CXR-dataCheck">
                    <input type="checkbox"
                      id="preTb_consultneed"
                      name=""><label>Further consulting needed</label>
                  </div>
                  <div class="col-sm-6">
                    <label>If no, Why</label>
                    <input type="textarea"
                      id="preTB_FurCoulting_ifnoWhy"
                      name=""
                      class="form-control">
                  </div>
                  <div class="col-sm-12">
            ...
            <div class="part-section">
              <div class="">
                <h3>Part B :After consulting with radiologist/supervisors</h3>
              </div>
              <div class="row"
                id="partB_data">
                <div class="col-sm-12">
                ...
                <div class="col-sm-3 need_teachAdv">
                  <input type="checkbox"
                    id="partB_needTeachAdv"
                    name=""><label>Need Teach team advice</label>
                </div>
                <div class="col-sm-2">
            ...
            <div class="row preTB_button">
              <div class="col-sm-2">
                <button class="btn btn-success preTB-assSave"
                  onclick="preTB_asseSave(this)"
                  disabled="true">Save Record</button>
              </div>
            </div>
          </div>
        </div>
        <div class="tab-pane fade"
          ...
          <form action="{{ route('preTB_Assement_data') }}"
            method="post">
            @csrf
...
<script type="text/javascript">
  ...
  function preTB_asseSave(button) {
    var preTB_saveData = {};
