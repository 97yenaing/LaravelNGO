      ...
      <div id="header_bar">
        <div class="row"  style="margin:auto;padding:10px 0%;" > <!-- Upper Section -->
          ...
          <h2 id='app-User'>{{ Auth::user()->name }}</h2>
            ...
            <div class="col-md-12 lab-headerDiv"  >
              ...
              <button type="button" class="btn btn-success lab-refresh lab-refreshPos" id="btn_refresh" onclick="wd_reload()">Refresh</button>
              <button type="button" class="btn btn-success lab-refresh lab-printer" id="btn_printblock">TO Print</button>
            </div> 
        ...
        <!-- Nav tabs -->
          ...
          <ul class="nav nav-tabs toggle lab-second-link" id="hidden-title" >
            ...
            <li class="nav-item">
              <a class="nav-link toggle-link" data-toggle="tab" id="lab_follow_up" href="#Lab_Follow_data" onclick="Lab_Follow_Test()" >Lab Test Patient</a>
            </li> 
             <li class="nav-item">
      ...
      <div>
        <div class="row genral-info" >
          <div class="col-sm-3 general-task">
            ...
            <div class="date-holder">
              <input type="text" id="vDate" class="form-control Gdate date-verify" autofocus placeholder="dd-mm-yyyy">
              <img src="../img/calendar3.svg" class="dateimg" alt="date">
            </div>
          </div>
          <div class="col-sm-3 general-task">
            <label for="validationCustom01" class="form-label">Patient's ID</label>
            <input id="cid" type="number"  onblur="ptData()" class="form-control" id="validationCustom01" >
          ...
          <div class="col-sm-3 main-risk" >
            ...
            <select class="form-select mrisk-data" id="Ptype" onchange="PatientType()" disabled>
          ...
          <div class="col-sm-3 sub-risk">
            <label class="form-label risk-label">Sub Risk</label>
              <select class="form-select srisk-data" id="ext" disabled>
              <option selected="" value="-"></option>
        ...
        <div id="printSection" class="print-Section clearfix">
            ...
            <div class="printbtn-block" style="padding-top:10px;">
                    <button type="button" id="printAll_lab" onclick="labprintAll()" class="btn btn-primary btn-lg lab-printAll ">PrintAll</button>
            </div>
            <div class="printbtn-block" style="padding-top:10px;">
                <button type="button" id="cancel_print"  class="btn btn-primary btn-lg lab-printcancel ">Print-Cancel</button>
            </div>
      ...
      <div class="tab-content lab-containers lab-diseaseSection no-margin">
        <div class="tab-pane container active lab-incon-div " id="hiv">
            ...
            <div class="col-sm-3 hiv-bloodDate">
              ...
              <div class="date-holder">
                <input type="text"  id="bcdate"  class="form-control Gdate date-verify" placeholder="dd-mm-yyyy">
                <img src="../img/calendar3.svg" class="dateimg" alt="date">
              </div>
            </div>
            ...
            <div class="col-sm-3 hiv-issue">
              ...
              <div class="date-holder">
                <input type="text"  id="issue_date" class="form-control Gdate date-verify" placeholder="dd-mm-yyyy">
                <img src="../img/calendar3.svg" class="dateimg" alt="date">
              </div>
            </div>
          </div>
            ...
            <div class="col-sm-3"style="padding-top:10px;">
              <button type="button" id="hivSave" onclick="hiv_save()" class="btn btn-primary btn-lg save-batton ">Save Data</button>
            </div>
            <div class="col-sm-4">
              <span id="noti"></span>
            </div>
        ...
        <div class="tab-pane container fade lab-incon-div " id="rpr">
          ...
          <div class="row">
            ...
            <div class="col-sm-3 lab-date">
              ...
              <div class="date-holder">
                <input type="text" id="lastTitreDate" class="form-control Gdate" placeholder="dd-mm-yyyy">
                <img src="../img/calendar3.svg" class="dateimg" alt="date">
              </div>
            </div>
            <!-- <div class="col-sm-2">  </div> -->
          ...
          <div class="row">
            ...
            <div class="col-sm-4 lab-issueDate">
              ...
              <div class="date-holder">
                <input type="text"  id="rpr_issue_date"  class="form-control Gdate date-verify" placeholder="dd-mm-yyyy">
                <img src="../img/calendar3.svg" class="dateimg" alt="date">
              </div>
            </div>
          </div>
          <div class="row save-updte">
            <div class="col-sm-3"style="padding-top:10px;">
              <button type="button" id="rprSave" onclick="rpr_save()" class="btn btn-primary btn-lg save-batton ">Save Data</button>
            </div>
            <div class="col-sm-2">
        ...
        <div class="tab-pane container fade lab-incon-div" id="hbc">
          ...
          <div class="row">
            ...
            <div class="col-sm-3 lab-issueDate">
              ...
              <div class="date-holder">
                <input type="text"  id="C_issueDate"  class="form-control Gdate date-verify" placeholder="dd-mm-yyyy">
                <img src="../img/calendar3.svg" class="dateimg" alt="date">
              </div>
            </div>
          </div>
          <div class="row save-updte">
            <div class="col-sm-3"style="padding-top:20px;">
              <button onclick="hbc_save()" id='hbcSave'type="button" class="btn btn-primary btn-lg save-batton ">Save Data</button>
            </div>
            <div class="col-sm-2">
            ...
            <p class="btn-stiList">
              ...
              <div class="row">
                ...
                <div class="col-sm-3 lab-issueDate">
                  ...
                  <div class="date-holder">
                    <input type="text"  id="sti_issueDate"  class="form-control Gdate date-verify" placeholder="dd-mm-yyyy">
                    <img src="../img/calendar3.svg" class="dateimg" alt="date">
                  </div>
                </div>
              </div>
              <div class="row save-updte">
                <div class="col-sm-3" style="padding-top:10px;">
                  <button type="button" id="stiSave" onclick="sti_save()" class="btn btn-primary btn-lg save-batton ">Save Data</button>
                </div>
                <div class="col-sm-2">
        ...
        <div class="tab-pane container fade lab-incon-div" id="urine">
            ...
            <div class="row">
              ...
              <div class="col-sm-3 lab-issueDate">
                ...
                <div class="date-holder">
                  <input type="text"  id="u_issuDate"  class="form-control Gdate date-verify" placeholder="dd-mm-yyyy">
                  <img src="../img/calendar3.svg" class="dateimg" alt="date">
                </div>
              </div>
            ...
            <div class="row save-updte">
              <div class="col-sm-3"style="padding-top:10px;">
                <button type="button" id="urineSave" onclick="Urine()" class="btn btn-primary btn-lg save-batton">Save Data</button>
              </div>
              <div class="col-sm-2">
        ...
        <div class="tab-pane container fade lab-incon-div" id="oi">
          ...
          <div class="row">
            ...
            <div class="col-sm-3 lab-issueDate">
              ...
              <div class="date-holder">
                <input type="text"  id="oi_issue_date"  class="form-control Gdate date-verify" placeholder="dd-mm-yyyy">
                <img src="../img/calendar3.svg" class="dateimg" alt="date">
              </div>
            </div>
          </div>
          <div class="row save-updte">
              <div class="col-sm-3"style="padding-top:10px;">
                <button type="button" id="oiSave" onclick="oi_save()" class="btn btn-primary btn-lg save-batton">Save Data</button>
              </div>
              <div class="col-sm-2">
        ...
        <div class="tab-pane container fade lab-incon-div" id="gt">
            ...
            <input type="text" class="form-control" id="rbs_result"  onchange="RBSResult()" value="0">
          </div>
              <!-- <div class="col-sm-3" >
            ...
            <input type="text" class="form-control" id="fbs_result" value="0" onchange="FBSResult()">
          </div>
          ...
          <div class="col-sm-3 lab-issueDate">
            ...
            <div class="date-holder">
              <input type="text"  id="gt_issue_date"  class="form-control Gdate date-verify" placeholder="dd-mm-yyyy">
              <img src="../img/calendar3.svg" class="dateimg" alt="date">
            </div>
          </div>
          </div>
          <div class="row save-updte">
            <div class="col-sm-3" style="padding-top:10px;">
              <button type="button" id="gtSave" onclick="gt_save()" class="btn btn-primary btn-lg save-batton">Save Data</button>
            </div>
            <div class="col-sm-2">
        ...
        <div class="tab-pane container fade lab-incon-div" id="stool">
          ...
          <div class="row">
            ...
            <div class="col-sm-3 lab-issueDate">
              ...
              <div class="date-holder">
                <input type="text"  id="st_issue_date"  class="form-control Gdate date-verify" placeholder="dd-mm-yyyy">
                <img src="../img/calendar3.svg" class="dateimg" alt="date">
              </div>
            </div>
          </div>
          <div class="row save-updte">
            <div class="col-sm-3"style="padding-top:10px;">
              <button type="button" id="stoolSave" onclick="stSave()" class="btn btn-primary btn-lg save-batton">Save Data</button>
            </div>
            <div class="col-sm-2">
        ...
        <div class="tab-pane container fade lab-incon-div" id="afb">
          ...
          <div class="row afb-slidedata afbslide-date" >
            ...
            <div class="col-sm-4" >
              ...
              <div class="date-holder">
                <input type="text"  id="speci_receive_dt1"   class="form-control Gdate date-verify" placeholder="dd-mm-yyyy">
                <img src="../img/calendar3.svg" class="dateimg" alt="date">
              </div>
            </div>
            <!-- <div class="col-sm-3"> </div>  -->
            <div class="col-sm-4 " >
              ...
              <div class="date-holder">
                <input type="text"  id="speci_receive_dt2"  class="form-control Gdate date-verify" placeholder="dd-mm-yyyy">
                <img src="../img/calendar3.svg" class="dateimg" alt="date">
              </div>
            </div>
          </div>
          ...
          <div class="row" >
            ...
            <div class="col-sm-3 lab-issueDate">
              ...
              <div class="date-holder">
                <input type="text"  id="afb_issue_date"  value="-" class="form-control Gdate date-verify" placeholder="dd-mm-yyyy">
                <img src="../img/calendar3.svg" class="dateimg" alt="date">
              </div>
          ...
          <div class="row save-updte" >
            <div class="col-sm-3"style="padding-top:10px;">
              <button type="button" id="afbSave" onclick="afb_save()" class="btn btn-primary btn-lg save-batton">Save Data</button>
            </div>
            <div class="col-sm-2">
        ...
        <div class="tab-pane container fade lab-incon-div" id="covid">
          ...
          <div class="row" >
            ...
            <div class="col-sm-3 lab-issueDate">
              ...
              <div class="date-holder">
                <input type="text"  id="covid_issue_date" class="form-control Gdate date-verify" placeholder="dd-mm-yyyy">
                <img src="../img/calendar3.svg" class="dateimg" alt="date">
              </div>
          ...
          <div class="row save-updte" >
            <div class="col-sm-3"style="padding-top:10px;">
              <button type="button" id="covidSave" onclick="covidData()" class="btn btn-primary btn-lg save-batton">Save Data</button>
            </div>
            <div class="col-sm-2">
        ...
        <div class="tab-pane container fade lab-incon-div" id="viral_load" >
          <div class="row ">
            <div class="col-sm-3 viralLoad-arso" >
              ...
              <div class="date-holder">
                <input type="text"  id="art_initial_date_time"   class="form-control Gdate" placeholder="dd-mm-yyyy">
                <img src="../img/calendar3.svg" class="dateimg" alt="date">
              </div>
            </div>
            ...
            <div class="col-sm-3 viralLoad-arso">
              ...
              <div class="date-holder">
                <input type="text"  id="sample_ship_date"   class="form-control Gdate" placeholder="dd-mm-yyyy">
                <img src="../img/calendar3.svg" class="dateimg" alt="date">
              </div>
            </div>
            <div class="col-sm-3 viralLoad-arso">
          ...
          <div class="row viralLoad-dateResult" >
            <div class="col-sm-3">
              ...
              <div class="date-holder">
                <input type="text"  id="result_received_date"   class="form-control Gdate" placeholder="dd-mm-yyyy">
                <img src="../img/calendar3.svg" class="dateimg" alt="date">
              </div>
            </div>
            <div class="col-sm-2 viralLoad-arso" >
          ...
          <div class="row save-updte" >
            <div class="col-sm-3"style="padding-top:10px;">
              <button type="button" id="viralSave" onclick="viral_load()" class="btn btn-primary btn-lg save-batton">Save Data</button>
            </div>
            <div class="col-sm-2">
        ...
        <div class="tab-pane container fade lab-incon-div"  id="Lab_Follow_data">
            <div class="row">
              <div class="col-sm-2">
                ...
                <div class="date-holder">
                  <input type="text" id="lab_follow_dateFrom" class="form-control Gdate date-verify" autofocus="" placeholder="dd-mm-yyyy">
                  <img src="../img/calendar3.svg" class="dateimg" alt="date">
                </div>
              </div>
              <div class="col-sm-2">
                ...
                <div class="date-holder">
                  <input type="text" id="lab_follow_dateTo" class="form-control Gdate date-verify" autofocus="" placeholder="dd-mm-yyyy">
                  <img src="../img/calendar3.svg" class="dateimg" alt="date">
                </div>
              </div>
              <div class="col-sm-2">
              ...
              <div class="col-sm-2">
                <button class="btn btn-info btn-primary btn-follow-search" onclick="Lab_Follow_Test()">Search</button>
              </div>
              <div class="col-sm-4">
      ...
      <div id="toshowResult_all" style="border: 1px solid #000000;" class='printAll-dispaly'>
        <div class="row no-margin print-HeadDiv">
          <div class="col-sm-12 print_allHeader">
            <img src="/logoMAM.jpg" class="rounded mx-auto d-block" alt="logo" style="width:70px;height:70px;float:left;">
        ...
        <div class="clearfix">
          ...
          <div class="row no-margin pirntAll-colDT">
            <div class="col-sm-8 no-margin"style="border: 1px solid black;padding-bottom:2px">Specimen collection<br> date & time</div>
            <div class="col-sm-4 no-padding  no-margin"id="printAll_collectionDT" style="border: 1px solid black;padding-top:10px;"></div>
        ...
        <div>
          ...
          <div class="row no-margin">
            ...
            <div class="col-sm-1  no-margin">(Pale yellow)</div>
          ...
          <div class="row no-margin">
            ...
            <div class="col-sm-2  no-margin">(70 - 180mg/dl)</div>
            <div class="col-sm-1  no-margin"></div>
          </div>
          <div class="row no-margin">
            ...
            <div class="col-sm-2  no-margin">(70 - 115mg/dl)</div>
            <div class="col-sm-1  no-margin"></div>
          </div>
          <div class="row no-margin">
          ...
          <div class="row no-margin">
            ...
            <div class="col-sm-4  no-margin">PMNL/HPF normal (Male &#60;5, Female &#60;20)</div>
          </div>
          <div class="row no-margin">
            <div class="col-sm-2 print_data no-margin"></div>
...
let hider = 0;let bton= 0; let rowNo=0; let rowID=0; let liveID=0;
let updateBundle=[];
var pirnt_header="";
let resp_old =[];
...
function labprintAll(){
  console.log("hello Print all list");
  $("#print_allTest").show(); 
                    ...
                    $.ajax({
                        ...
                        success:function(response){
                            ...
                            if(patientData.length!=0){
                              ...
                              if(hivprint.length!=0||rprprint.length!=0||stiprint.length!=0||hbcprint.length!=0||urineprint.length!=0
                              ||oiprint.length!=0||generalprint.length!=0||stoolprint.length!=0||afbprint.length!=0||covidprint.length!=0
                              ||viralprint.length!=0){
                              ...
                              if(rprprint.length>0){
                                ...
                                if($("#printAll_collectionDT").text()=="-"||$("#printAll_collectionDT").text()==""){
                              ...
                              if(stiprint.length>0){
                                ...
                                $("#allSti_gcintraUrineGc").text(stiprint[0]['First Per Urine Diplococci Intra-Cell']);
                                ...
                                $("#allSti_gcextraUrineGc").text(stiprint[0]['First Per Urine Diplococci Extra-Cell']);
                              ...
                              if(generalprint.length>0){
                                ...
                                var malgeneralStatus=generalprint[0]['Malaria_spec']+""+generalprint[0]['Malaria_grade']+""+generalprint[0]['Malaria_stage']
                              ...
                              if(response[11][0]['Gender']=="195997324"){
                                  ...
                                  $("#allSti_clueUrethra,#allSti_clueEndo,#allSti_clueRec,#allSti_trichUrethra,#allSti_trichPosteria,#allSti_trichEndo,#allSti_trichRec,#allSti_gcintraWet,#allSti_gcextraWet,#allSti_candidaRec").text("");
                                 
 
                                  $("#allSti_clueUrethra,#allSti_clueEndo,#allSti_clueRec,#allSti_trichUrethra,#allSti_trichPosteria,#allSti_trichEndo,#allSti_trichRec,#allSti_gcintraWet,#allSti_gcextraWet,#allSti_candidaRec").css("background","grey");
          ...
          case "HIV":
           ...
           var follow_data_head=$("<tr>").append($("<td>").text("CID"))
            ...
            $.each(response[0], function(index,follow_data) {
              var follow_data_list=$("<tr>").append($("<td>").text(follow_data["CID"]))
            ...
            $("#lab_follow_noti").html("HIV Positive: " + hiv_positive + "<br>" + "HIV Negative: " + hiv_neg);
            break;
          case "RPR":
            var rdt_test=rdt_pos=rdt_neg=rpr_test=rpr_pos=rpr_neg=rdt_unknown=rpr_unknown=rdt_not=rpr_not=0;
            var follow_data_head=$("<tr>").append($("<td>").text("CID"))
                                          .append($("<td>").text("Vdate"))
                                          .append($("<td>").text("Age"))
                                          .append($("<td>").text("Req_Doc"))
            ...
            $("#lab_follow_show table thead").append(follow_data_head);
            $.each(response[0], function(index,follow_data) {
              var follow_data_list=$("<tr>").append($("<td>").text(follow_data["pid"]))
                                            .append($("<td>").text(follow_data["vdate"]))
                                            .append($("<td>").text(follow_data["agey"]))
                                            .append($("<td>").text(follow_data["Req_Doctor"]))
              ...
              $("#lab_follow_noti").html("Total_Patient:"+response[0].length+"\t"+"RDT_Not:"+rdt_not+"\t"+"RPR_Not:"+rpr_not+
              "<br>"+"RDT Positive: " + rdt_pos + "\t" + ",RDT Negative: " + rdt_neg + "\t" + ",RDT Unkown: " +rdt_unknown+"<br>"+
              "RPR Reactive: " + rpr_pos + "\t" + ",RPR Non Reactive: " + rpr_neg + "\t" + ",RPR Unkown: " +rpr_unknown);
                                            
              $("#lab_follow_show table tbody").append(follow_data_list)
            })
            break;
          case "BC":
            var hepB_pos=hepB_neg=hepB_unknown=hepC_pos=hepC_neg=hepC_unkown=hepB_not=hepC_not=0;
            var follow_data_head=$("<tr>").append($("<td>").text("CID"))
                                          .append($("<td>").text("Vdate"))
                                          .append($("<td>").text("Age"))
                                          .append($("<td>").text("Req_Doc"))
            ...
            $.each(response[0], function(index,follow_data) {
              ...
              $("#lab_follow_noti").html("Total_Patient:"+response[0].length+"\t"+"HepB_Not:"+hepB_not+"\t"+"HepC_Not:"+hepC_not+
              "<br>"+"HepB Positive: " + hepB_pos + "\t" + ",HepB Negative: " + hepB_neg + "\t" + ",HepB Unkown: " +hepB_unknown+"<br>"+
              "HepC Positive: " + hepC_pos + "\t" + ",HepC Negative: " + hepC_neg + "\t" + ",HepC Unkown: " +hepC_unkown);
...
function hiv_save(){
  ...
  if(cid.length >8 && final_result !="-" && present == 1&&lab_tech.length>2 ){
    ...
    $.ajax({
      ...
      setTimeout(function(){
        $("#noti").show();
        document.getElementById('noti').innerHTML="Please check the 'ID' , 'Results' 'MD' and 'Lab-Tech'.";
  ...
  if(cid.length >8 && result_present==1 && present == 1&&lab_tech_rpr!="-"&&
   ((rdtYes_no=="Done"&& Sy_rdt_result.length>2) ||(rprYes_NO=="Done"  && qualitative.length>2)) ){
    ...
    $.ajax({
      ...
      setTimeout(function(){
        $("#noti_rpr").show();
        document.getElementById('noti_rpr').innerHTML="Please check the 'ID','Results','MD' , 'Lab-Tech',''.";
...
function afb_save(){
  ...
  var afbData={
    ...
    afb_issue_Fdate     :afb_issue_date,
    test_type		:test_type,
  ...
  $.ajax({
    ...
    success:function(response){
      ...
      if(response[14].length>0){
        $("#testHistory").empty();
        var test_name=['HIV','RPR','STI','Hepatitis','Urine','OI','General','Stool','AFB','Covid','Viral Load']
        for (var i = 0; i < response[14].length; i++) {
          ...
          //+"<td>"+""+"</td>"
          +"<td id='"+btnName+"'>"+ "<button  onclick='row_num()' class='btn btn-primary labUpdate-btn'>"+" Update Data"+"</button>"+
            "<select  class='form-select lab-update-select' id="+select_labUp+"><option value='All'>All</option></select>"+
            "<button  onclick='remove_row()'  class='btn btn-danger lab-del-btn' id=lab_del_"+i+">Delete</button>"+
            "</td>"
          +"</tr>";
...
function remove_row(){
  ...
  if (remove_test=="All") {
    ...
    test_seqs = test_seq.map(function() { return $(this).val(); }).get(); 
