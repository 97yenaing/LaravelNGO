      ...
      <div id="hider0">
        <div class="row genral-info" >
          <div class="col-sm-3 general-task">
            ...
            <input id="cid" type="number" autofocus onchange="ptData()" class="form-control" id="validationCustom01" required>
      ...
      <div class="tab-content lab-containers">
        ...
        <div class="tab-pane container fade lab-incon-div" id="finder">
          ...
          <div class="row finder-row">
            <div class="col-md-3">
              <input id="id_hist" type="number" autofocus  class="form-control" placeholder="Patient's ID" required>
              <div class="valid-feedback">
                Plz put Patient's ID.
              </div>
            </div>
