...
@auth
<body>
  <div class="container lab-report-tank">
    ...
    <div id="header0">
      ...
      <div class="row">
        ...
        <div class="col-sm-2">
          ...
          <div class="date-holder">
                <input type="text" id="d_to" onblur="days_show()" class="form-control Gdate date-verify" placeholder="dd-mm-yyyy">
                <img src="../img/calendar3.svg" class="dateimg" alt="date">
          </div>
        </div>
        <div class="col-sm-1">
...
<script type="text/javascript">
  ...
  function days_show(){
    ...
    // Parse the date strings into a format that JavaScript can understand (DD-MM-YYYY).
    var date_from_parts = date_from.split('-');
    var date_to_parts = date_to.split('-');

    // Create Date objects with the parsed parts.
    var dd_from = new Date(date_from_parts[2], date_from_parts[1] - 1, date_from_parts[0]);
    var dd_to = new Date(date_to_parts[2], date_to_parts[1] - 1, date_to_parts[0]);

    var daysCount = dd_to.getTime() - dd_from.getTime();
    var df_indays = Math.ceil(daysCount / (1000 * 3600 * 24)) + 1;
  ...
  function hiv_report_table(){
    ...
    var date_to = document.getElementById('d_to').value;
        ...
        var from_to = "<h4 style='color:#003865'>"+"HIV Testing Report"+"("+date_from+"     to    "+date_to+")"+"</h4>";
  ...
  function rpr_report_table(){
    ...
    var date_to = document.getElementById('d_to').value;
        ...
        var from_to = "<h4 style='color:#003865'>"+"RPR Testing Report"+"("+date_from+"     to    "+date_to+")"+"</h4>";
        var result_body = "<br>"+"<table class='table table-bordered'>"+
            "<thead>"+
  ...
  function hep_report_table(){
    ...
    var date_from = document.getElementById('d_from').value;
    var date_to = document.getElementById('d_to').value;
        var from_to = "<h4 style='color:#003865'>"+"Hep B & C Testing Report"+"("+date_from+"     to    "+date_to+")"+"</h4>";
        var result_body = "<br>"+"<table class='table table-bordered'>"+
            "<thead>"+
                "<tr>"
                  +"<td>"+"Hep B & C"+"</td>"+
  ...
  function sti_report_table(){
    ...
    var date_to = document.getElementById('d_to').value;
        ...
        var from_to = "<h4 style='color:#003865'>"+"STI (Female) Testing Report"+"("+date_from+"     to    "+date_to+")"+"</h4>";
        var result_body = "<br>"+"<table class='table table-bordered'>"+
            "<thead>"+
                "<tr>" +"<td>"+"Total No."+"</td>"+"<td>"+"GC (IE)"+"</td>"+"<td>"+"GC (E)Only"+"</td>"+"<td>"+"TV"+"<td>"+"Candida"+"<td>"+"Clue cell > 20%"+"</td>"+"<td>"+"PMNL > 20"+"</td>"+"</tr>"+
            "</thead>"+
            "<tbody>"+
                "<tr>"+"<td>"+resp[2]+"</td>"+"<td>"+resp[4]+"</td>"+"<td>"+resp[6]+"</td>"+"<td>"+resp[8]+"</td>"+"<td>"+resp[12]+"</td>"+"<td>"+resp[9]+"</td>"+"<td>"+resp[11]+"</td>"+"</tr>"+
          "</tbody>"+
        "</table>" ;
        $("#reportSpace").append(from_to+result_body);

        var from_to1 = "<h4 style='color:#003865'>"+"STI (Male) Testing Report"+"("+date_from+"     to    "+date_to+")"+"</h4>";
        var result_body1 = "<br>"+"<table class='table table-bordered'>"+
            "<thead>"+
                "<tr>" +"<td>"+"Total No."+"</td>"+"<td>"+"GC (I)"+"</td>"+"<td>"+"GC (E)Only"+"</td>"+"<td>"+"TV"+"<td>"+"Candida"+"<td>"+"Clue cell >20%"+"</td>"+"<td>"+"PMNL > 5"+"</td>"+"</tr>"+
            "</thead>"+
            "<tbody>"+
                  "<tr>"+"<td>"+resp[1]+"</td>"+"<td>"+resp[3]+"</td>"+"<td>"+resp[5]+"</td>"+"<td>"+resp[7]+"</td>"+"<td>"+resp[13]+"</td>"+"<td>"+""+"</td>"+"<td>"+resp[10]+"</td>"+"</tr>"+
          "</tbody>"+
        "</table>" ;
  ...
  function tb_report_table(){
    ...
    var date_to = document.getElementById('d_to').value;
        ...
        var from_to = "<h4 style='color:#003865'>"+"TB (Sputum) Testing Report"+"("+date_from+"     to    "+date_to+")"+"</h4>";
        var result_body = "<br>"+"<table class='table table-bordered'>"+
            "<thead>"+
            ...
            "<tbody>"+
                ...
                "<tr>"+"<td>"+"Slides"+"</td>"+"<td>"+resp[28]+"</td>"+"<td>"+ resp[29]+"</td>"+"<td>"+resp[30]+"</td>"+"<td>"+resp[31]+"</td>"+"<td>"+resp[32]+"</td>"+"<td>"+resp[33]+"</td>"+"</tr>"+

          "</tbody>"+
        "</table>" ;
        $("#reportSpace").append(from_to+result_body);

        var from_to1 = "<h4 style='color:#003865'>"+"TB (Other) Testing Report"+"("+date_from+"     to    "+date_to+")"+"</h4>";
        var result_body1 = "<br>"+"<table class='table table-bordered'>"+
            "<thead>"+
        ...
        var from_to2 = "<h4 style='color:#003865'>"+"TB LAM Testing Report"+"("+date_from+"     to    "+date_to+")"+"</h4>";
  ...
  function dengue_report_table(){
    ...
    var date_to = document.getElementById('d_to').value;
        ...
        var from_to = "<h4 style='color:#003865'>"+"Dengue Testing Report"+"("+date_from+"     to    "+date_to+")"+"</h4>";
        var result_body = "<br>"+"<table class='table table-bordered'>"+
            "<thead>"+
  ...
  function malaria_report_table(){
    ...
    var date_to = document.getElementById('d_to').value;
        ...
        var from_to = "<h4 style='color:#003865'>"+"Malaria Testing Report"+"("+date_from+"     to    "+date_to+")"+"</h4>";
        var result_body = "<br>"+"<table class='table table-bordered'>"+
            "<thead>"+
                "<tr>" 
                  +"<td>"+"Malaria"+"</td>"
  ...
  function oi_report_table(){
    ...
    var date_to = document.getElementById('d_to').value;
        ...
        var from_to = "<h4 style='color:#003865'>"+"OI Testing Report"+"("+date_from+"     to    "+date_to+")"+"</h4>";
        var result_body = "<br>"+"<table class='table table-bordered'>"+
            "<thead>"+
                "<tr>" +"<td>"+"Crypto Ag Test"+"</td>"+"<td>"+"Total No."+"</td>"+"<td>"+"Positive"+"</td>"+"<td>"+"Negative"+"</td>"+"</tr>"+
            "</thead>"+
            "<tbody>"+
        ...
        var from_to1 = "<h4 style='color:#003865'>"+"OI"+"("+date_from+"     to    "+date_to+")"+"</h4>";
        var result_body1 = "<br>"+"<table class='table table-bordered'>"+
            "<thead>"+
                  "<tr>" +"<td>"+"OI Microscopy"+"</td>"+"<td>"+"Total No."+"</td>"+"<td>"+"Stain  Smear"+"</td>"+"<td>"+"India Ink"+"</td>"+"</tr>"+
            "</thead>"+
            "<tbody>"+
            "<tr>"+
              "<td>"+"Crypto"+"</td>"+"<td>"+resp[7]+"</td>"+"<td>"+resp[8]+"</td>"+"<td>"+resp[9]+"</td>"+"</tr>"+
            "<tr>"+"<td>"+"Pen"+"</td>"+"<td>"+resp[10]+"</td>"+"<td>"+resp[11]+"</td>"+"<td>"+resp[12]+"</td>"+"</tr>"+
            "<tr>"+"<td>"+"Other"+"</td>"+"<td>"+resp[13]+"</td>"+"<td>"+resp[14]+"</td>"+"<td>"+resp[15]+"</td>"+"</tr>"+
          "</tbody>"+
        "</table>" ;
        $("#reportSpace").append(from_to1+result_body1);
  }
  function generalTest_report_table(){
    ...
    var date_to = document.getElementById('d_to').value;
        ...
        var from_to = "<h4 style='color:#003865'>"+"General Testing Report"+"("+date_from+"     to    "+date_to+")"+"</h4>";
        var result_body = "<br>"+"<table class='table table-bordered'>"+
            "<thead>"+
