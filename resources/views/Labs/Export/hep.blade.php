            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td style="width:100px;">{{ $value['Hiv status'] }}</td>
                    <td style="width:100px;">{{ $value['HepB Test'] }}</td>
                    <td style="width:100px;">{{ $value['HepB TOT'] }}</td>
                    <td style="width:100px;">{{ $value['HepB Result'] }}</td>
                    <td style="width:100px;">{{ $value['HepC Test'] }}</td>
                    <td style="width:100px;">{{ $value['HepC TOT'] }}</td>
                    <td style="width:100px;">{{ $value['HepC Result'] }}</td>
