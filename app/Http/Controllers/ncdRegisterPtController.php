  ...
  public function ncdRegister_data(Request $request)
  {
    ...
    if ($notice == "Find Patient") {
      ...
      if ($patientinfo != null) {
        ...
        $patientinfo = Export_age::Export_general($patientinfo, "", $patientinfo["Date of Birth"], $patientinfo);
      }
    ...
    if ($notice == "Find Follow History") {
      ...
      $ncdFollow_name = [
        ...
        "ncdV_Gli1000_frequency",
        "F_Gliclazide(1000)_duration",
        "ncdV_Gli1000_duration",
        "F_Gliclazide(1000)_durUnit",
        "ncdV_Gli1000_durUnit",
