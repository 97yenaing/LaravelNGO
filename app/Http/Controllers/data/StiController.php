...

{
  ...
  public function stidata(Request $request){
    ...
    if($ckPatient == 1)//to check the patient is in sti table
    {
      ...
      $rprResult = Rprtest::where('pid',$pid)->get();
                ...
                if($patientMale != null||$patientFemale != null){
                    $update = 333;
                    return response()->json([
                      $pid, $patientMale,$patientFemale,$rprResult,$update,
    ...
    if($ckpatient_find == 1){
      ...
      $general_pt = PtConfig::where('Pid',$pid)->get();
      ...
      if($general_pt != null||$patientMale != null||$patientFemale != null){
          $sex = Crypt::decrypt_light($general_pt[0]["Gender"],$table);
          $risk_factor = Crypt::decrypt_light($general_pt[0]["Main Risk"],$table);
                    
          return response()->json([
           $general_pt, $patientMale,$patientFemale,$rprResult,$sex,$risk_factor,$rpr_qualitative,
          ]);
      }
    }
    ...
    if($sti_male == 1)   // STI Male Data Collector (Create)
    {
         ...
         Stimale::create([
          // Crypt::encrypt_light($request->input('Counsellor'),$table);
              ...
              //   //'tbl_demog_first_visit'        => Crypt::encryptString($request -> tbl_demog_firt_visit),
              ...
              //   'prodromal_itch'               => Crypt::encrypt_light($request->input('prodromal_itch'),$table),
              ...
              //   'estimated_siz'                => Crypt::encrypt_light($request->input('phi_estimated_size'),$table),
              ...
              //   'presumptive_diag'             => Crypt::encrypt_light($request->input('presumptive_diag'),$table),
              ...
              //   'other(please specify)'        => Crypt::encrypt_light($request->input('others33'),$table),
              ...
              //   'tre_remarks'                  => Crypt::encrypt_light($request->input('remarkTreatment'),$table),
              //   'followup'                     => Crypt::encrypt_light($request->input('follwupText'),$table),
              //   'clinician_name'               => Crypt::encrypt_light($request->input('clinicainName'),$table),
              ...
              //'tbl_demog_first_visit'        => Crypt::encrypt_light( Crypt::encryptString($request -> tbl_demog_firt_visit),$table),
              'last_vis_within'              => Crypt::encrypt_light($request->input('lastVisit'),$table),
              'age'                          =>$request -> age,
              'about_clinic'                 => Crypt::encrypt_light($request->input('aboutclinic'),$table),
    ...
    if($sti_male == 2) // STI Male Data Updater ( Update )
    {
        ...
        Stimale::where('id',$updateID)
                ...
                //  'non_gono_cervities'                              =>Crypt::encrypt_light( $request -> ,$table),
                  ...
                  'other(please specify)'        =>Crypt::encrypt_light( $request -> others33,$table),
    ...
    if($sti_Updated_fill=="sti_fill_data"){
      ...
      $patientMale=[]; $patientFemale=[]; $test;
      ...
      if($updatedsex=="male") {
        ...
        $felarge_encData=['oth_GI_sympt','genital_blisters_Location',
          'des_size','risk_cal_remark','presumptive_diag','tre_remarks',
          'followup',
          'clinician',
        ];
      ...
      return response()->json([
        $gt_pateint,$patientMale,$patientFemale,
       ]);
